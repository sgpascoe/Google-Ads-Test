...
(function (fields) {
    ...
    /*  -- ENUM FIELDS --  */
    fields.enumFields = {
        "accessible_bidding_strategy.target_impression_share.location": "TargetImpressionShareLocation",
        "accessible_bidding_strategy.type": "BiddingStrategyType",
        ...
        "ad_group_ad.ad.display_upload_ad.display_upload_product_type": "DisplayUploadProductType",
        "ad_group_ad.ad.image_ad.mime_type": "MimeType",
        "ad_group_ad.ad.legacy_responsive_display_ad.format_setting": "DisplayAdFormatSetting",
        "ad_group_ad.ad.responsive_display_ad.format_setting": "DisplayAdFormatSetting",
        "ad_group_ad.ad.system_managed_resource_source": "SystemManagedResourceSource",
        "ad_group_ad.ad.type": "AdType",
        "ad_group_ad.ad.video_ad.discovery.thumbnail": "VideoThumbnail",
        ...
        "ad_group_bid_modifier.hotel_date_selection_type.type": "HotelDateSelectionType",
        ...
        "ad_group_criterion.listing_group.case_value.product_bidding_category.level": "ProductBiddingCategoryLevel",
        ...
        "ad_group_criterion.listing_group.case_value.product_custom_attribute.index": "ProductCustomAttributeIndex",
        "ad_group_criterion.listing_group.case_value.product_type.level": "ProductTypeLevel",
        "ad_group_criterion.listing_group.type": "ListingGroupType",
        "ad_group_criterion.parental_status.type": "ParentalStatusType",
        "ad_group_criterion.quality_info.creative_quality_score": "QualityScoreBucket",
        "ad_group_criterion.quality_info.post_click_quality_score": "QualityScoreBucket",
        ...
        "ad_group_criterion_customizer.status": "CustomizerValueStatus",
        "ad_group_criterion_customizer.value.type": "CustomizerAttributeType",
        "ad_group_criterion_simulation.modification_method": "SimulationModificationMethod",
        "ad_group_criterion_simulation.type": "SimulationType",
        "ad_group_customizer.status": "CustomizerValueStatus",
        "ad_group_customizer.value.type": "CustomizerAttributeType",
        ...
        "asset.lead_form_asset.post_submit_call_to_action_type": "LeadFormPostSubmitCallToActionType",
        "asset.mobile_app_asset.app_store": "MobileAppVendor",
        "asset.policy_summary.approval_status": "PolicyApprovalStatus",
        "asset.policy_summary.review_status": "PolicyReviewStatus",
        "asset.price_asset.price_qualifier": "PriceExtensionPriceQualifier",
        "asset.price_asset.type": "PriceExtensionType",
        "asset.promotion_asset.discount_modifier": "PromotionExtensionDiscountModifier",
        ...
        "asset_group_asset.policy_summary.approval_status": "PolicyApprovalStatus",
        "asset_group_asset.policy_summary.review_status": "PolicyReviewStatus",
        "asset_group_asset.status": "AssetLinkStatus",
        "asset_group_listing_group_filter.case_value.product_bidding_category.level": "ListingGroupFilterBiddingCategoryLevel",
        ...
        "asset_group_listing_group_filter.vertical": "ListingGroupFilterVertical",
        "asset_set.status": "AssetSetStatus",
        ...
        "bidding_seasonality_adjustment.advertising_channel_types": "AdvertisingChannelType",
        ...
        "bidding_strategy.target_impression_share.location": "TargetImpressionShareLocation",
        "bidding_strategy.type": "BiddingStrategyType",
        "bidding_strategy_simulation.modification_method": "SimulationModificationMethod",
        ...
        "campaign.geo_target_type_setting.negative_geo_target_type": "NegativeGeoTargetType",
        "campaign.geo_target_type_setting.positive_geo_target_type": "PositiveGeoTargetType",
        "campaign.local_campaign_setting.location_source_type": "LocationSourceType",
        "campaign.optimization_goal_setting.optimization_goal_types": "OptimizationGoalType",
        ...
        "campaign.vanity_pharma.vanity_pharma_display_url_mode": "VanityPharmaDisplayUrlMode",
        ...
        "campaign_asset_set.status": "AssetSetLinkStatus",
        ...
        "campaign_conversion_goal.category": "ConversionActionCategory",
        "campaign_conversion_goal.origin": "ConversionOrigin",
        ...
        "campaign_criterion_simulation.modification_method": "SimulationModificationMethod",
        "campaign_criterion_simulation.type": "SimulationType",
        "campaign_customizer.status": "CustomizerValueStatus",
        "campaign_customizer.value.type": "CustomizerAttributeType",
        "campaign_draft.status": "CampaignDraftStatus",
        "campaign_experiment.status": "CampaignExperimentStatus",
        "campaign_experiment.traffic_split_type": "CampaignExperimentTrafficSplitType",
        ...
        "conversion_action.attribution_model_settings.attribution_model": "AttributionModel",
        "conversion_action.attribution_model_settings.data_driven_model_status": "DataDrivenModelStatus",
        ...
        "conversion_action.origin": "ConversionOrigin",
        ...
        "conversion_goal_campaign_config.goal_config_level": "GoalConfigLevel",
        "conversion_value_rule.action.operation": "ValueRuleOperation",
        "conversion_value_rule.device_condition.device_types": "ValueRuleDeviceType",
        "conversion_value_rule.geo_location_condition.excluded_geo_match_type": "ValueRuleGeoLocationMatchType",
        "conversion_value_rule.geo_location_condition.geo_match_type": "ValueRuleGeoLocationMatchType",
        ...
        "custom_conversion_goal.status": "CustomConversionGoalStatus",
        "custom_interest.status": "CustomInterestStatus",
        "custom_interest.type": "CustomInterestType",
        "customer.pay_per_conversion_eligibility_failure_reasons": "CustomerPayPerConversionEligibilityFailureReason",
        ...
        "customer_conversion_goal.category": "ConversionActionCategory",
        "customer_conversion_goal.origin": "ConversionOrigin",
        "customer_customizer.status": "CustomizerValueStatus",
        "customer_customizer.value.type": "CustomizerAttributeType",
        ...
        "customizer_attribute.status": "CustomizerAttributeStatus",
        "customizer_attribute.type": "CustomizerAttributeType",
        ...
        "extension_feed_item.call_feed_item.call_conversion_reporting_state": "CallConversionReportingState",
        "extension_feed_item.device": "FeedItemTargetDevice",
        "extension_feed_item.extension_type": "ExtensionType",
        "extension_feed_item.price_feed_item.price_qualifier": "PriceExtensionPriceQualifier",
        "extension_feed_item.price_feed_item.type": "PriceExtensionType",
        "extension_feed_item.promotion_feed_item.discount_modifier": "PromotionExtensionDiscountModifier",
        "extension_feed_item.promotion_feed_item.occasion": "PromotionExtensionOccasion",
        "extension_feed_item.status": "FeedItemStatus",
        "extension_feed_item.targeted_keyword.match_type": "KeywordMatchType",
        "feed.affiliate_location_feed_data.relationship_type": "AffiliateLocationFeedRelationshipType",
        ...
        "feed_item_set.dynamic_location_set_filter.business_name_filter.filter_type": "FeedItemSetStringFilterType",
        ...
        "hotel_reconciliation.status": "HotelReconciliationStatus",
        ...
        "segments.budget_campaign_association_status.status": "BudgetCampaignAssociationStatus",
        "segments.click_type": "ClickType",
        "segments.conversion_action_category": "ConversionActionCategory",
        "segments.conversion_attribution_event_type": "ConversionAttributionEventType",
        "segments.conversion_lag_bucket": "ConversionLagBucket",
        "segments.conversion_or_adjustment_lag_bucket": "ConversionOrAdjustmentLagBucket",
        "segments.conversion_value_rule_primary_dimension": "ConversionValueRulePrimaryDimension",
        ...
        "segments.recommendation_type": "RecommendationType",
        ...
        "user_list.rule_based_user_list.combined_rule_user_list.left_operand.rule_type": "UserListRuleType",
        ...
        "user_list.rule_based_user_list.date_specific_rule_user_list.rule.rule_type": "UserListRuleType",
