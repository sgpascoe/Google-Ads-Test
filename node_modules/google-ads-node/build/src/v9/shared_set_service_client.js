...
exports.SharedSetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/shared_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./shared_set_service_client_config.json");
...
class SharedSetServiceClient {
    /**
     * Construct an instance of SharedSetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.SharedSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.sharedSetServiceStub) {
            return this.sharedSetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.SharedSetService.
        this.sharedSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.SharedSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.SharedSetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const sharedSetServiceStubMethods = ['getSharedSet', 'mutateSharedSets'];
        for (const methodName of sharedSetServiceStubMethods) {
            const callPromise = this.sharedSetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getSharedSet(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getSharedSet(request, options, callback);
    }
    mutateSharedSets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.sharedSetServiceStub.then(stub => {
...
exports.SharedSetServiceClient = SharedSetServiceClient;
//# sourceMappingURL=shared_set_service_client.js.map