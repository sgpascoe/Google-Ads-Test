 ...
 * `src/v9/ad_group_feed_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_feed_service_client_config.json");
...
class AdGroupFeedServiceClient {
    /**
     * Construct an instance of AdGroupFeedServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupFeedService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupFeedServiceStub) {
            return this.adGroupFeedServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupFeedService.
        this.adGroupFeedServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupFeedService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupFeedService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupFeedServiceStubMethods = ['getAdGroupFeed', 'mutateAdGroupFeeds'];
        for (const methodName of adGroupFeedServiceStubMethods) {
            const callPromise = this.adGroupFeedServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupFeed(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroupFeeds(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAdGroupFeeds(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupFeedServiceStub.then(stub => {
...
//# sourceMappingURL=ad_group_feed_service_client.js.map