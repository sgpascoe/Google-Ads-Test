 ...
 * `src/v9/campaign_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_service_client_config.json");
...
class CampaignServiceClient {
    /**
     * Construct an instance of CampaignServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignServiceStub) {
            return this.campaignServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignService.
        this.campaignServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignServiceStubMethods = ['getCampaign', 'mutateCampaigns'];
        for (const methodName of campaignServiceStubMethods) {
            const callPromise = this.campaignServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaign(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaigns(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=campaign_service_client.js.map