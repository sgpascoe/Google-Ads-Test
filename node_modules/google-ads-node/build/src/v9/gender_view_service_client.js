...
exports.GenderViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/gender_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./gender_view_service_client_config.json");
...
class GenderViewServiceClient {
    /**
     * Construct an instance of GenderViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.GenderViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.genderViewServiceStub) {
            return this.genderViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.GenderViewService.
        this.genderViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.GenderViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.GenderViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const genderViewServiceStubMethods = ['getGenderView'];
        for (const methodName of genderViewServiceStubMethods) {
            const callPromise = this.genderViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getGenderView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getGenderView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.genderViewServiceStub.then(stub => {
...
exports.GenderViewServiceClient = GenderViewServiceClient;
//# sourceMappingURL=gender_view_service_client.js.map