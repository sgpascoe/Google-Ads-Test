 ...
 * `src/v9/ad_group_criterion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_criterion_service_client_config.json");
...
class AdGroupCriterionServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupCriterionServiceStub) {
            return this.adGroupCriterionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupCriterionService.
        this.adGroupCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupCriterionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupCriterionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupCriterionServiceStubMethods = ['getAdGroupCriterion', 'mutateAdGroupCriteria'];
        for (const methodName of adGroupCriterionServiceStubMethods) {
            const callPromise = this.adGroupCriterionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupCriterion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroupCriteria(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupCriterionServiceStub.then(stub => {
...
//# sourceMappingURL=ad_group_criterion_service_client.js.map