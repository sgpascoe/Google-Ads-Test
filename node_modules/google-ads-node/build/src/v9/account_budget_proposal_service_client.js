 ...
 * `src/v9/account_budget_proposal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./account_budget_proposal_service_client_config.json");
...
class AccountBudgetProposalServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AccountBudgetProposalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.ads.googleads.v9.services.AccountBudgetProposalService.
        this.accountBudgetProposalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AccountBudgetProposalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AccountBudgetProposalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const accountBudgetProposalServiceStubMethods = ['getAccountBudgetProposal', 'mutateAccountBudgetProposal'];
        for (const methodName of accountBudgetProposalServiceStubMethods) {
            const callPromise = this.accountBudgetProposalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAccountBudgetProposal(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAccountBudgetProposal(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=account_budget_proposal_service_client.js.map