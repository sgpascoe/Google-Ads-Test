...
exports.DistanceViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/distance_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./distance_view_service_client_config.json");
...
class DistanceViewServiceClient {
    /**
     * Construct an instance of DistanceViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.DistanceViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.distanceViewServiceStub) {
            return this.distanceViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.DistanceViewService.
        this.distanceViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.DistanceViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.DistanceViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const distanceViewServiceStubMethods = ['getDistanceView'];
        for (const methodName of distanceViewServiceStubMethods) {
            const callPromise = this.distanceViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDistanceView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getDistanceView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.distanceViewServiceStub.then(stub => {
...
exports.DistanceViewServiceClient = DistanceViewServiceClient;
//# sourceMappingURL=distance_view_service_client.js.map