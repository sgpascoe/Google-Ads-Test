...
exports.CurrencyConstantServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/currency_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./currency_constant_service_client_config.json");
...
class CurrencyConstantServiceClient {
    /**
     * Construct an instance of CurrencyConstantServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CurrencyConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.currencyConstantServiceStub) {
            return this.currencyConstantServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CurrencyConstantService.
        this.currencyConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CurrencyConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CurrencyConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const currencyConstantServiceStubMethods = ['getCurrencyConstant'];
        for (const methodName of currencyConstantServiceStubMethods) {
            const callPromise = this.currencyConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCurrencyConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getCurrencyConstant(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.currencyConstantServiceStub.then(stub => {
...
exports.CurrencyConstantServiceClient = CurrencyConstantServiceClient;
//# sourceMappingURL=currency_constant_service_client.js.map