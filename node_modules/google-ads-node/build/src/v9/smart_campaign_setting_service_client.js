...
exports.SmartCampaignSettingServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/smart_campaign_setting_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./smart_campaign_setting_service_client_config.json");
...
class SmartCampaignSettingServiceClient {
    /**
     * Construct an instance of SmartCampaignSettingServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.SmartCampaignSettingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.smartCampaignSettingServiceStub) {
            return this.smartCampaignSettingServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.SmartCampaignSettingService.
        this.smartCampaignSettingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.SmartCampaignSettingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.SmartCampaignSettingService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const smartCampaignSettingServiceStubMethods = ['getSmartCampaignSetting', 'mutateSmartCampaignSettings'];
        for (const methodName of smartCampaignSettingServiceStubMethods) {
            const callPromise = this.smartCampaignSettingServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getSmartCampaignSetting(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateSmartCampaignSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.SmartCampaignSettingServiceClient = SmartCampaignSettingServiceClient;
//# sourceMappingURL=smart_campaign_setting_service_client.js.map