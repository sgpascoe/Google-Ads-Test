...
exports.BiddingStrategySimulationServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/bidding_strategy_simulation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./bidding_strategy_simulation_service_client_config.json");
...
class BiddingStrategySimulationServiceClient {
    /**
     * Construct an instance of BiddingStrategySimulationServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.BiddingStrategySimulationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.biddingStrategySimulationServiceStub) {
            return this.biddingStrategySimulationServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.BiddingStrategySimulationService.
        this.biddingStrategySimulationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.BiddingStrategySimulationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.BiddingStrategySimulationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const biddingStrategySimulationServiceStubMethods = ['getBiddingStrategySimulation'];
        for (const methodName of biddingStrategySimulationServiceStubMethods) {
            const callPromise = this.biddingStrategySimulationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getBiddingStrategySimulation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getBiddingStrategySimulation(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.biddingStrategySimulationServiceStub.then(stub => {
...
exports.BiddingStrategySimulationServiceClient = BiddingStrategySimulationServiceClient;
//# sourceMappingURL=bidding_strategy_simulation_service_client.js.map