 ...
 * `src/v9/customer_manager_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_manager_link_service_client_config.json");
...
class CustomerManagerLinkServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerManagerLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerManagerLinkServiceStub) {
            return this.customerManagerLinkServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerManagerLinkService.
        this.customerManagerLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerManagerLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerManagerLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerManagerLinkServiceStubMethods = ['getCustomerManagerLink', 'mutateCustomerManagerLink', 'moveManagerLink'];
        for (const methodName of customerManagerLinkServiceStubMethods) {
            const callPromise = this.customerManagerLinkServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerManagerLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomerManagerLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    moveManagerLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerManagerLinkServiceStub.then(stub => {
...
//# sourceMappingURL=customer_manager_link_service_client.js.map