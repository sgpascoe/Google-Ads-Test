 ...
 * `src/v9/campaign_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_label_service_client_config.json");
...
class CampaignLabelServiceClient {
    /**
     * Construct an instance of CampaignLabelServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignLabelServiceStub) {
            return this.campaignLabelServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignLabelService.
        this.campaignLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignLabelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignLabelService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignLabelServiceStubMethods = ['getCampaignLabel', 'mutateCampaignLabels'];
        for (const methodName of campaignLabelServiceStubMethods) {
            const callPromise = this.campaignLabelServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignLabel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getCampaignLabel(request, options, callback);
    }
    mutateCampaignLabels(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignLabelServiceStub.then(stub => {
...
//# sourceMappingURL=campaign_label_service_client.js.map