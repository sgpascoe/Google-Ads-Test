...
exports.ClickViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/click_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./click_view_service_client_config.json");
...
class ClickViewServiceClient {
    /**
     * Construct an instance of ClickViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ClickViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.clickViewServiceStub) {
            return this.clickViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ClickViewService.
        this.clickViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ClickViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ClickViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const clickViewServiceStubMethods = ['getClickView'];
        for (const methodName of clickViewServiceStubMethods) {
            const callPromise = this.clickViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getClickView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getClickView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.clickViewServiceStub.then(stub => {
...
exports.ClickViewServiceClient = ClickViewServiceClient;
//# sourceMappingURL=click_view_service_client.js.map