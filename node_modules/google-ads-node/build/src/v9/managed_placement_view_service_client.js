...
exports.ManagedPlacementViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/managed_placement_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./managed_placement_view_service_client_config.json");
...
class ManagedPlacementViewServiceClient {
    /**
     * Construct an instance of ManagedPlacementViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ManagedPlacementViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.managedPlacementViewServiceStub) {
            return this.managedPlacementViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ManagedPlacementViewService.
        this.managedPlacementViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ManagedPlacementViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ManagedPlacementViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const managedPlacementViewServiceStubMethods = ['getManagedPlacementView'];
        for (const methodName of managedPlacementViewServiceStubMethods) {
            const callPromise = this.managedPlacementViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getManagedPlacementView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getManagedPlacementView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.managedPlacementViewServiceStub.then(stub => {
...
exports.ManagedPlacementViewServiceClient = ManagedPlacementViewServiceClient;
//# sourceMappingURL=managed_placement_view_service_client.js.map