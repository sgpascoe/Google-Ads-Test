 ...
 * `src/v9/custom_audience_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./custom_audience_service_client_config.json");
...
class CustomAudienceServiceClient {
    /**
     * Construct an instance of CustomAudienceServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomAudienceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customAudienceServiceStub) {
            return this.customAudienceServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomAudienceService.
        this.customAudienceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomAudienceService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomAudienceService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customAudienceServiceStubMethods = ['getCustomAudience', 'mutateCustomAudiences'];
        for (const methodName of customAudienceServiceStubMethods) {
            const callPromise = this.customAudienceServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomAudience(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomAudiences(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCustomAudiences(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customAudienceServiceStub.then(stub => {
...
//# sourceMappingURL=custom_audience_service_client.js.map