...
exports.BiddingSeasonalityAdjustmentServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/bidding_seasonality_adjustment_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./bidding_seasonality_adjustment_service_client_config.json");
...
class BiddingSeasonalityAdjustmentServiceClient {
    /**
     * Construct an instance of BiddingSeasonalityAdjustmentServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.BiddingSeasonalityAdjustmentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.biddingSeasonalityAdjustmentServiceStub) {
            return this.biddingSeasonalityAdjustmentServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.BiddingSeasonalityAdjustmentService.
        this.biddingSeasonalityAdjustmentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.BiddingSeasonalityAdjustmentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.BiddingSeasonalityAdjustmentService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const biddingSeasonalityAdjustmentServiceStubMethods = ['getBiddingSeasonalityAdjustment', 'mutateBiddingSeasonalityAdjustments'];
        for (const methodName of biddingSeasonalityAdjustmentServiceStubMethods) {
            const callPromise = this.biddingSeasonalityAdjustmentServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getBiddingSeasonalityAdjustment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateBiddingSeasonalityAdjustments(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.biddingSeasonalityAdjustmentServiceStub.then(stub => {
...
exports.BiddingSeasonalityAdjustmentServiceClient = BiddingSeasonalityAdjustmentServiceClient;
//# sourceMappingURL=bidding_seasonality_adjustment_service_client.js.map