 ...
 * `src/v9/smart_campaign_suggest_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./smart_campaign_suggest_service_client_config.json");
...
class SmartCampaignSuggestServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.SmartCampaignSuggestService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.smartCampaignSuggestServiceStub) {
            return this.smartCampaignSuggestServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.SmartCampaignSuggestService.
        this.smartCampaignSuggestServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.SmartCampaignSuggestService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.SmartCampaignSuggestService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const smartCampaignSuggestServiceStubMethods = ['suggestSmartCampaignBudgetOptions', 'suggestSmartCampaignAd', 'suggestKeywordThemes'];
        for (const methodName of smartCampaignSuggestServiceStubMethods) {
            const callPromise = this.smartCampaignSuggestServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    suggestSmartCampaignBudgetOptions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    suggestSmartCampaignAd(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    suggestKeywordThemes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=smart_campaign_suggest_service_client.js.map