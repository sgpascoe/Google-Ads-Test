...
exports.InvoiceServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/invoice_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./invoice_service_client_config.json");
...
class InvoiceServiceClient {
    /**
     * Construct an instance of InvoiceServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.InvoiceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.invoiceServiceStub) {
            return this.invoiceServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.InvoiceService.
        this.invoiceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.InvoiceService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.InvoiceService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const invoiceServiceStubMethods = ['listInvoices'];
        for (const methodName of invoiceServiceStubMethods) {
            const callPromise = this.invoiceServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listInvoices(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.invoiceServiceStub.then(stub => {
...
//# sourceMappingURL=invoice_service_client.js.map