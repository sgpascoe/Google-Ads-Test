 ...
 * `src/v9/customer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_service_client_config.json");
...
class CustomerServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerServiceStub) {
            return this.customerServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerService.
        this.customerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerServiceStubMethods = ['getCustomer', 'mutateCustomer', 'listAccessibleCustomers', 'createCustomerClient'];
        for (const methodName of customerServiceStubMethods) {
            const callPromise = this.customerServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomer(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomer(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listAccessibleCustomers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    createCustomerClient(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=customer_service_client.js.map