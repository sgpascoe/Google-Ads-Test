...
exports.DomainCategoryServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/domain_category_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./domain_category_service_client_config.json");
...
class DomainCategoryServiceClient {
    /**
     * Construct an instance of DomainCategoryServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.DomainCategoryService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.domainCategoryServiceStub) {
            return this.domainCategoryServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.DomainCategoryService.
        this.domainCategoryServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.DomainCategoryService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.DomainCategoryService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const domainCategoryServiceStubMethods = ['getDomainCategory'];
        for (const methodName of domainCategoryServiceStubMethods) {
            const callPromise = this.domainCategoryServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDomainCategory(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getDomainCategory(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.domainCategoryServiceStub.then(stub => {
...
exports.DomainCategoryServiceClient = DomainCategoryServiceClient;
//# sourceMappingURL=domain_category_service_client.js.map