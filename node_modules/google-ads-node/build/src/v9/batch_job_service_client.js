 ...
 * `src/v9/batch_job_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./batch_job_service_client_config.json");
...
class BatchJobServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listBatchJobResults: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'results')
        };
        ...
        const runBatchJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const runBatchJobMetadata = protoFilesRoot.lookup('.google.ads.googleads.v9.resources.BatchJob.BatchJobMetadata');
        this.descriptors.longrunning = {
            runBatchJob: new this._gaxModule.LongrunningDescriptor(this.operationsClient, runBatchJobResponse.decode.bind(runBatchJobResponse), runBatchJobMetadata.decode.bind(runBatchJobMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.BatchJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.batchJobServiceStub) {
            return this.batchJobServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.BatchJobService.
        this.batchJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.BatchJobService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.BatchJobService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const batchJobServiceStubMethods = ['mutateBatchJob', 'getBatchJob', 'listBatchJobResults', 'runBatchJob', 'addBatchJobOperations'];
        for (const methodName of batchJobServiceStubMethods) {
            const callPromise = this.batchJobServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateBatchJob(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getBatchJob(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    addBatchJobOperations(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    runBatchJob(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkRunBatchJobProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.runBatchJob, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listBatchJobResults(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listBatchJobResultsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        return this.descriptors.page.listBatchJobResults.createStream(this.innerApiCalls.listBatchJobResults, request, callSettings);
    }
    /**
     ...
     */
    listBatchJobResultsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listBatchJobResults.asyncIterate(this.innerApiCalls['listBatchJobResults'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=batch_job_service_client.js.map