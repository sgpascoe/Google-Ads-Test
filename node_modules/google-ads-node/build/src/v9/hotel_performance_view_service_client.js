...
exports.HotelPerformanceViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/hotel_performance_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./hotel_performance_view_service_client_config.json");
...
class HotelPerformanceViewServiceClient {
    /**
     * Construct an instance of HotelPerformanceViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.HotelPerformanceViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.hotelPerformanceViewServiceStub) {
            return this.hotelPerformanceViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.HotelPerformanceViewService.
        this.hotelPerformanceViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.HotelPerformanceViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.HotelPerformanceViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const hotelPerformanceViewServiceStubMethods = ['getHotelPerformanceView'];
        for (const methodName of hotelPerformanceViewServiceStubMethods) {
            const callPromise = this.hotelPerformanceViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getHotelPerformanceView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getHotelPerformanceView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.hotelPerformanceViewServiceStub.then(stub => {
...
exports.HotelPerformanceViewServiceClient = HotelPerformanceViewServiceClient;
//# sourceMappingURL=hotel_performance_view_service_client.js.map