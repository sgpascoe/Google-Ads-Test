...
exports.CampaignBudgetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_budget_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_budget_service_client_config.json");
...
class CampaignBudgetServiceClient {
    /**
     * Construct an instance of CampaignBudgetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignBudgetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignBudgetServiceStub) {
            return this.campaignBudgetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignBudgetService.
        this.campaignBudgetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignBudgetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignBudgetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignBudgetServiceStubMethods = ['getCampaignBudget', 'mutateCampaignBudgets'];
        for (const methodName of campaignBudgetServiceStubMethods) {
            const callPromise = this.campaignBudgetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignBudget(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaignBudgets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignBudgetServiceStub.then(stub => {
...
exports.CampaignBudgetServiceClient = CampaignBudgetServiceClient;
//# sourceMappingURL=campaign_budget_service_client.js.map