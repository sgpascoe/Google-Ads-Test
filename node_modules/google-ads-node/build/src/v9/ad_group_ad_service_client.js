 ...
 * `src/v9/ad_group_ad_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_ad_service_client_config.json");
...
class AdGroupAdServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupAdService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupAdServiceStub) {
            return this.adGroupAdServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupAdService.
        this.adGroupAdServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupAdService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupAdService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupAdServiceStubMethods = ['getAdGroupAd', 'mutateAdGroupAds'];
        for (const methodName of adGroupAdServiceStubMethods) {
            const callPromise = this.adGroupAdServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupAd(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroupAds(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=ad_group_ad_service_client.js.map