...
exports.AdGroupExtensionSettingServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_extension_setting_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_extension_setting_service_client_config.json");
...
class AdGroupExtensionSettingServiceClient {
    /**
     * Construct an instance of AdGroupExtensionSettingServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupExtensionSettingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupExtensionSettingServiceStub) {
            return this.adGroupExtensionSettingServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupExtensionSettingService.
        this.adGroupExtensionSettingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupExtensionSettingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupExtensionSettingService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupExtensionSettingServiceStubMethods = ['getAdGroupExtensionSetting', 'mutateAdGroupExtensionSettings'];
        for (const methodName of adGroupExtensionSettingServiceStubMethods) {
            const callPromise = this.adGroupExtensionSettingServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupExtensionSetting(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroupExtensionSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAdGroupExtensionSettings(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupExtensionSettingServiceStub.then(stub => {
...
exports.AdGroupExtensionSettingServiceClient = AdGroupExtensionSettingServiceClient;
//# sourceMappingURL=ad_group_extension_setting_service_client.js.map