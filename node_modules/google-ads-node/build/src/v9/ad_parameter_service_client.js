 ...
 * `src/v9/ad_parameter_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_parameter_service_client_config.json");
...
class AdParameterServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdParameterService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adParameterServiceStub) {
            return this.adParameterServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdParameterService.
        this.adParameterServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdParameterService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdParameterService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adParameterServiceStubMethods = ['getAdParameter', 'mutateAdParameters'];
        for (const methodName of adParameterServiceStubMethods) {
            const callPromise = this.adParameterServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdParameter(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdParameters(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adParameterServiceStub.then(stub => {
...
//# sourceMappingURL=ad_parameter_service_client.js.map