 ...
 * `src/v9/campaign_experiment_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_experiment_service_client_config.json");
...
class CampaignExperimentServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listCampaignExperimentAsyncErrors: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'errors')
        };
        ...
        const createCampaignExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const createCampaignExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v9.services.CreateCampaignExperimentMetadata');
        const promoteCampaignExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const promoteCampaignExperimentMetadata = protoFilesRoot.lookup('.google.protobuf.Empty');
        this.descriptors.longrunning = {
            createCampaignExperiment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createCampaignExperimentResponse.decode.bind(createCampaignExperimentResponse), createCampaignExperimentMetadata.decode.bind(createCampaignExperimentMetadata)),
            promoteCampaignExperiment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, promoteCampaignExperimentResponse.decode.bind(promoteCampaignExperimentResponse), promoteCampaignExperimentMetadata.decode.bind(promoteCampaignExperimentMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignExperimentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignExperimentServiceStub) {
            return this.campaignExperimentServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignExperimentService.
        this.campaignExperimentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignExperimentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignExperimentService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignExperimentServiceStubMethods = ['getCampaignExperiment', 'createCampaignExperiment', 'mutateCampaignExperiments', 'graduateCampaignExperiment', 'promoteCampaignExperiment', 'endCampaignExperiment', 'listCampaignExperimentAsyncErrors'];
        for (const methodName of campaignExperimentServiceStubMethods) {
            const callPromise = this.campaignExperimentServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignExperiment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaignExperiments(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    graduateCampaignExperiment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    endCampaignExperiment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    createCampaignExperiment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateCampaignExperimentProgress(name) {
    ...
    promoteCampaignExperiment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkPromoteCampaignExperimentProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listCampaignExperimentAsyncErrors(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listCampaignExperimentAsyncErrorsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        return this.descriptors.page.listCampaignExperimentAsyncErrors.createStream(this.innerApiCalls.listCampaignExperimentAsyncErrors, request, callSettings);
    }
    /**
     ...
     */
    listCampaignExperimentAsyncErrorsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listCampaignExperimentAsyncErrors.asyncIterate(this.innerApiCalls['listCampaignExperimentAsyncErrors'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
     ...
     * @returns {string} Resource name string.
     */
    campaignCriterionSimulationPath(customerId, campaignId, criterionId, type, modificationMethod, startDate, endDate) {
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromCampaignCriterionSimulationName(campaignCriterionSimulationName) {
     ...
     * @returns {string} A string representing the campaign_id.
     */
    matchCampaignIdFromCampaignCriterionSimulationName(campaignCriterionSimulationName) {
     ...
     * @returns {string} A string representing the criterion_id.
     */
    matchCriterionIdFromCampaignCriterionSimulationName(campaignCriterionSimulationName) {
     ...
     * @returns {string} A string representing the type.
     */
    matchTypeFromCampaignCriterionSimulationName(campaignCriterionSimulationName) {
     ...
     * @returns {string} A string representing the modification_method.
     */
    matchModificationMethodFromCampaignCriterionSimulationName(campaignCriterionSimulationName) {
     ...
     * @returns {string} A string representing the start_date.
     */
    matchStartDateFromCampaignCriterionSimulationName(campaignCriterionSimulationName) {
     ...
     * @returns {string} A string representing the end_date.
     */
    matchEndDateFromCampaignCriterionSimulationName(campaignCriterionSimulationName) {
     ...
     * @returns {string} Resource name string.
     */
    campaignExperimentPath(customerId, campaignExperimentId) {
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromCampaignExperimentName(campaignExperimentName) {
     ...
     */
    matchCampaignExperimentIdFromCampaignExperimentName(campaignExperimentName) {
     ...
     * @returns {string} Resource name string.
     */
    merchantCenterLinkPath(customerId, merchantCenterId) {
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromMerchantCenterLinkName(merchantCenterLinkName) {
     ...
     */
    matchMerchantCenterIdFromMerchantCenterLinkName(merchantCenterLinkName) {
     ...
     * @returns {string} Resource name string.
     */
    productBiddingCategoryConstantPath(countryCode, level, id) {
     ...
     */
    matchCountryCodeFromProductBiddingCategoryConstantName(productBiddingCategoryConstantName) {
     ...
     */
    matchLevelFromProductBiddingCategoryConstantName(productBiddingCategoryConstantName) {
     ...
     */
    matchIdFromProductBiddingCategoryConstantName(productBiddingCategoryConstantName) {
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignExperimentServiceStub.then(stub => {
...
//# sourceMappingURL=campaign_experiment_service_client.js.map