 ...
 * `src/v9/custom_conversion_goal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./custom_conversion_goal_service_client_config.json");
...
class CustomConversionGoalServiceClient {
    /**
     * Construct an instance of CustomConversionGoalServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomConversionGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customConversionGoalServiceStub) {
            return this.customConversionGoalServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomConversionGoalService.
        this.customConversionGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomConversionGoalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomConversionGoalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customConversionGoalServiceStubMethods = ['mutateCustomConversionGoals'];
        for (const methodName of customConversionGoalServiceStubMethods) {
            const callPromise = this.customConversionGoalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCustomConversionGoals(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCustomConversionGoals(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customConversionGoalServiceStub.then(stub => {
...
//# sourceMappingURL=custom_conversion_goal_service_client.js.map