 ...
 * `src/v9/keyword_theme_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./keyword_theme_constant_service_client_config.json");
...
class KeywordThemeConstantServiceClient {
    /**
     * Construct an instance of KeywordThemeConstantServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.KeywordThemeConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.keywordThemeConstantServiceStub) {
            return this.keywordThemeConstantServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.KeywordThemeConstantService.
        this.keywordThemeConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.KeywordThemeConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.KeywordThemeConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordThemeConstantServiceStubMethods = ['getKeywordThemeConstant', 'suggestKeywordThemeConstants'];
        for (const methodName of keywordThemeConstantServiceStubMethods) {
            const callPromise = this.keywordThemeConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getKeywordThemeConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    suggestKeywordThemeConstants(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.keywordThemeConstantServiceStub.then(stub => {
...
//# sourceMappingURL=keyword_theme_constant_service_client.js.map