...
exports.UserListServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/user_list_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./user_list_service_client_config.json");
...
class UserListServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.UserListService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.ads.googleads.v9.services.UserListService.
        this.userListServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.UserListService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.UserListService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const userListServiceStubMethods = ['getUserList', 'mutateUserLists'];
        for (const methodName of userListServiceStubMethods) {
            const callPromise = this.userListServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getUserList(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateUserLists(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.UserListServiceClient = UserListServiceClient;
//# sourceMappingURL=user_list_service_client.js.map