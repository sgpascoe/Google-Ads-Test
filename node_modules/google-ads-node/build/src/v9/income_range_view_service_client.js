...
exports.IncomeRangeViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/income_range_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./income_range_view_service_client_config.json");
...
class IncomeRangeViewServiceClient {
    /**
     * Construct an instance of IncomeRangeViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.IncomeRangeViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.incomeRangeViewServiceStub) {
            return this.incomeRangeViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.IncomeRangeViewService.
        this.incomeRangeViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.IncomeRangeViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.IncomeRangeViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const incomeRangeViewServiceStubMethods = ['getIncomeRangeView'];
        for (const methodName of incomeRangeViewServiceStubMethods) {
            const callPromise = this.incomeRangeViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getIncomeRangeView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getIncomeRangeView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.incomeRangeViewServiceStub.then(stub => {
...
exports.IncomeRangeViewServiceClient = IncomeRangeViewServiceClient;
//# sourceMappingURL=income_range_view_service_client.js.map