...
exports.AdScheduleViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_schedule_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_schedule_view_service_client_config.json");
...
class AdScheduleViewServiceClient {
    /**
     * Construct an instance of AdScheduleViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdScheduleViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adScheduleViewServiceStub) {
            return this.adScheduleViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdScheduleViewService.
        this.adScheduleViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdScheduleViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdScheduleViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adScheduleViewServiceStubMethods = ['getAdScheduleView'];
        for (const methodName of adScheduleViewServiceStubMethods) {
            const callPromise = this.adScheduleViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdScheduleView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAdScheduleView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adScheduleViewServiceStub.then(stub => {
...
exports.AdScheduleViewServiceClient = AdScheduleViewServiceClient;
//# sourceMappingURL=ad_schedule_view_service_client.js.map