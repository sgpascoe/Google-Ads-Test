...
exports.CampaignSimulationServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_simulation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_simulation_service_client_config.json");
...
class CampaignSimulationServiceClient {
    /**
     * Construct an instance of CampaignSimulationServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignSimulationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignSimulationServiceStub) {
            return this.campaignSimulationServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignSimulationService.
        this.campaignSimulationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignSimulationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignSimulationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignSimulationServiceStubMethods = ['getCampaignSimulation'];
        for (const methodName of campaignSimulationServiceStubMethods) {
            const callPromise = this.campaignSimulationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignSimulation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getCampaignSimulation(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignSimulationServiceStub.then(stub => {
...
exports.CampaignSimulationServiceClient = CampaignSimulationServiceClient;
//# sourceMappingURL=campaign_simulation_service_client.js.map