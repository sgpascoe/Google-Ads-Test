...
exports.LifeEventServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/life_event_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./life_event_service_client_config.json");
 ...
 * @memberof v9
 */
class LifeEventServiceClient {
    /**
     * Construct an instance of LifeEventServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.LifeEventService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.lifeEventServiceStub) {
            return this.lifeEventServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.LifeEventService.
        this.lifeEventServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.LifeEventService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.LifeEventService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const lifeEventServiceStubMethods = ['getLifeEvent'];
        for (const methodName of lifeEventServiceStubMethods) {
            const callPromise = this.lifeEventServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getLifeEvent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getLifeEvent(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.lifeEventServiceStub.then(stub => {
...
exports.LifeEventServiceClient = LifeEventServiceClient;
//# sourceMappingURL=life_event_service_client.js.map