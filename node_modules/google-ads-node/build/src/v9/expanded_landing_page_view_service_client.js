...
exports.ExpandedLandingPageViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/expanded_landing_page_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./expanded_landing_page_view_service_client_config.json");
...
class ExpandedLandingPageViewServiceClient {
    /**
     * Construct an instance of ExpandedLandingPageViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ExpandedLandingPageViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.expandedLandingPageViewServiceStub) {
            return this.expandedLandingPageViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ExpandedLandingPageViewService.
        this.expandedLandingPageViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ExpandedLandingPageViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ExpandedLandingPageViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const expandedLandingPageViewServiceStubMethods = ['getExpandedLandingPageView'];
        for (const methodName of expandedLandingPageViewServiceStubMethods) {
            const callPromise = this.expandedLandingPageViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getExpandedLandingPageView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getExpandedLandingPageView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.expandedLandingPageViewServiceStub.then(stub => {
...
exports.ExpandedLandingPageViewServiceClient = ExpandedLandingPageViewServiceClient;
//# sourceMappingURL=expanded_landing_page_view_service_client.js.map