 ...
 * @memberof v9
 */
export declare class BiddingDataExclusionServiceClient {
    private _terminated;
    private _opts;
    ...
    biddingDataExclusionServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     */
    getBiddingDataExclusion(request?: protos.google.ads.googleads.v9.services.IGetBiddingDataExclusionRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.resources.IBiddingDataExclusion,
        protos.google.ads.googleads.v9.services.IGetBiddingDataExclusionRequest | undefined,
        {} | undefined
    ]>;
    getBiddingDataExclusion(request: protos.google.ads.googleads.v9.services.IGetBiddingDataExclusionRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.resources.IBiddingDataExclusion, protos.google.ads.googleads.v9.services.IGetBiddingDataExclusionRequest | null | undefined, {} | null | undefined>): void;
    getBiddingDataExclusion(request: protos.google.ads.googleads.v9.services.IGetBiddingDataExclusionRequest, callback: Callback<protos.google.ads.googleads.v9.resources.IBiddingDataExclusion, protos.google.ads.googleads.v9.services.IGetBiddingDataExclusionRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [MutateBiddingDataExclusionsResponse]{@link google.ads.googleads.v9.services.MutateBiddingDataExclusionsResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     ...
     */
    mutateBiddingDataExclusions(request?: protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsResponse,
        protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsRequest | undefined,
        {} | undefined
    ]>;
    mutateBiddingDataExclusions(request: protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsResponse, protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsRequest | null | undefined, {} | null | undefined>): void;
    mutateBiddingDataExclusions(request: protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsRequest, callback: Callback<protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsResponse, protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsRequest | null | undefined, {} | null | undefined>): void;
    /**
