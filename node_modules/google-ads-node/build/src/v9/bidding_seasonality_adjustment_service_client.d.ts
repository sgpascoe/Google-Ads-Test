 ...
 * @memberof v9
 */
export declare class BiddingSeasonalityAdjustmentServiceClient {
    private _terminated;
    private _opts;
    ...
    biddingSeasonalityAdjustmentServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     *   The first element of the array is an object representing [BiddingSeasonalityAdjustment]{@link google.ads.googleads.v9.resources.BiddingSeasonalityAdjustment}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/bidding_seasonality_adjustment_service.get_bidding_seasonality_adjustment.js</caption>
     * region_tag:googleads_v9_generated_BiddingSeasonalityAdjustmentService_GetBiddingSeasonalityAdjustment_async
     */
    getBiddingSeasonalityAdjustment(request?: protos.google.ads.googleads.v9.services.IGetBiddingSeasonalityAdjustmentRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.resources.IBiddingSeasonalityAdjustment,
        protos.google.ads.googleads.v9.services.IGetBiddingSeasonalityAdjustmentRequest | undefined,
        {} | undefined
    ]>;
    getBiddingSeasonalityAdjustment(request: protos.google.ads.googleads.v9.services.IGetBiddingSeasonalityAdjustmentRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.resources.IBiddingSeasonalityAdjustment, protos.google.ads.googleads.v9.services.IGetBiddingSeasonalityAdjustmentRequest | null | undefined, {} | null | undefined>): void;
    getBiddingSeasonalityAdjustment(request: protos.google.ads.googleads.v9.services.IGetBiddingSeasonalityAdjustmentRequest, callback: Callback<protos.google.ads.googleads.v9.resources.IBiddingSeasonalityAdjustment, protos.google.ads.googleads.v9.services.IGetBiddingSeasonalityAdjustmentRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [MutateBiddingSeasonalityAdjustmentsResponse]{@link google.ads.googleads.v9.services.MutateBiddingSeasonalityAdjustmentsResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/bidding_seasonality_adjustment_service.mutate_bidding_seasonality_adjustments.js</caption>
     * region_tag:googleads_v9_generated_BiddingSeasonalityAdjustmentService_MutateBiddingSeasonalityAdjustments_async
     */
    mutateBiddingSeasonalityAdjustments(request?: protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsResponse,
        protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsRequest | undefined,
        {} | undefined
    ]>;
    mutateBiddingSeasonalityAdjustments(request: protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsResponse, protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsRequest | null | undefined, {} | null | undefined>): void;
    mutateBiddingSeasonalityAdjustments(request: protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsRequest, callback: Callback<protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsResponse, protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsRequest | null | undefined, {} | null | undefined>): void;
    /**
