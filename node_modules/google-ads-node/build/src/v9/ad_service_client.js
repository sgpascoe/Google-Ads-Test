...
exports.AdServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_service_client_config.json");
...
class AdServiceClient {
    /**
     * Construct an instance of AdServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adServiceStub) {
            return this.adServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdService.
        this.adServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adServiceStubMethods = ['getAd', 'mutateAds'];
        for (const methodName of adServiceStubMethods) {
            const callPromise = this.adServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAd(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAds(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAds(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adServiceStub.then(stub => {
...
//# sourceMappingURL=ad_service_client.js.map