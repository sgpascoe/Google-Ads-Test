...
exports.DetailedDemographicServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/detailed_demographic_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./detailed_demographic_service_client_config.json");
 ...
 * @memberof v9
 */
class DetailedDemographicServiceClient {
    /**
     * Construct an instance of DetailedDemographicServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.DetailedDemographicService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.detailedDemographicServiceStub) {
            return this.detailedDemographicServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.DetailedDemographicService.
        this.detailedDemographicServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.DetailedDemographicService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.DetailedDemographicService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const detailedDemographicServiceStubMethods = ['getDetailedDemographic'];
        for (const methodName of detailedDemographicServiceStubMethods) {
            const callPromise = this.detailedDemographicServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDetailedDemographic(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getDetailedDemographic(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.detailedDemographicServiceStub.then(stub => {
...
exports.DetailedDemographicServiceClient = DetailedDemographicServiceClient;
//# sourceMappingURL=detailed_demographic_service_client.js.map