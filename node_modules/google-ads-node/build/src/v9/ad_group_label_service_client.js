...
exports.AdGroupLabelServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_label_service_client_config.json");
...
class AdGroupLabelServiceClient {
    /**
     * Construct an instance of AdGroupLabelServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupLabelServiceStub) {
            return this.adGroupLabelServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupLabelService.
        this.adGroupLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupLabelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupLabelService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupLabelServiceStubMethods = ['getAdGroupLabel', 'mutateAdGroupLabels'];
        for (const methodName of adGroupLabelServiceStubMethods) {
            const callPromise = this.adGroupLabelServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupLabel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroupLabels(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAdGroupLabels(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupLabelServiceStub.then(stub => {
...
exports.AdGroupLabelServiceClient = AdGroupLabelServiceClient;
//# sourceMappingURL=ad_group_label_service_client.js.map