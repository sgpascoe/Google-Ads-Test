...
exports.CustomerFeedServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/customer_feed_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_feed_service_client_config.json");
...
class CustomerFeedServiceClient {
    /**
     * Construct an instance of CustomerFeedServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerFeedService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerFeedServiceStub) {
            return this.customerFeedServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerFeedService.
        this.customerFeedServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerFeedService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerFeedService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerFeedServiceStubMethods = ['getCustomerFeed', 'mutateCustomerFeeds'];
        for (const methodName of customerFeedServiceStubMethods) {
            const callPromise = this.customerFeedServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerFeed(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomerFeeds(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerFeedServiceStub.then(stub => {
...
exports.CustomerFeedServiceClient = CustomerFeedServiceClient;
//# sourceMappingURL=customer_feed_service_client.js.map