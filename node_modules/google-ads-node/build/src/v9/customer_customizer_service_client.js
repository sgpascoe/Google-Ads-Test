...
exports.CustomerCustomizerServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/customer_customizer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_customizer_service_client_config.json");
 ...
 * @memberof v9
 */
class CustomerCustomizerServiceClient {
    /**
     * Construct an instance of CustomerCustomizerServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerCustomizerServiceStub) {
            return this.customerCustomizerServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerCustomizerService.
        this.customerCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerCustomizerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerCustomizerService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerCustomizerServiceStubMethods = ['mutateCustomerCustomizers'];
        for (const methodName of customerCustomizerServiceStubMethods) {
            const callPromise = this.customerCustomizerServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCustomerCustomizers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCustomerCustomizers(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerCustomizerServiceStub.then(stub => {
...
exports.CustomerCustomizerServiceClient = CustomerCustomizerServiceClient;
//# sourceMappingURL=customer_customizer_service_client.js.map