 ...
 * `src/v9/user_data_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./user_data_service_client_config.json");
...
class UserDataServiceClient {
    /**
     * Construct an instance of UserDataServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.UserDataService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.userDataServiceStub) {
            return this.userDataServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.UserDataService.
        this.userDataServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.UserDataService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.UserDataService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const userDataServiceStubMethods = ['uploadUserData'];
        for (const methodName of userDataServiceStubMethods) {
            const callPromise = this.userDataServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    uploadUserData(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
...
//# sourceMappingURL=user_data_service_client.js.map