 ...
 * `src/v9/customer_extension_setting_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_extension_setting_service_client_config.json");
...
class CustomerExtensionSettingServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerExtensionSettingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerExtensionSettingServiceStub) {
            return this.customerExtensionSettingServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerExtensionSettingService.
        this.customerExtensionSettingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerExtensionSettingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerExtensionSettingService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerExtensionSettingServiceStubMethods = ['getCustomerExtensionSetting', 'mutateCustomerExtensionSettings'];
        for (const methodName of customerExtensionSettingServiceStubMethods) {
            const callPromise = this.customerExtensionSettingServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerExtensionSetting(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomerExtensionSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerExtensionSettingServiceStub.then(stub => {
...
//# sourceMappingURL=customer_extension_setting_service_client.js.map