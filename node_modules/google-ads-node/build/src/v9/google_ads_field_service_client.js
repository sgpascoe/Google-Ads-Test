 ...
 * `src/v9/google_ads_field_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./google_ads_field_service_client_config.json");
...
class GoogleAdsFieldServiceClient {
    /**
     * Construct an instance of GoogleAdsFieldServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            searchGoogleAdsFields: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'results')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.GoogleAdsFieldService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.googleAdsFieldServiceStub) {
            return this.googleAdsFieldServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.GoogleAdsFieldService.
        this.googleAdsFieldServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.GoogleAdsFieldService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.GoogleAdsFieldService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const googleAdsFieldServiceStubMethods = ['getGoogleAdsField', 'searchGoogleAdsFields'];
        for (const methodName of googleAdsFieldServiceStubMethods) {
            const callPromise = this.googleAdsFieldServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getGoogleAdsField(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    searchGoogleAdsFields(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing [GoogleAdsField]{@link google.ads.googleads.v9.resources.GoogleAdsField} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
     *   We recommend using `searchGoogleAdsFieldsAsync()`
     *   method described below for async iteration which you can stop as needed.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
     *   for more details and examples.
     */
    searchGoogleAdsFieldsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        return this.descriptors.page.searchGoogleAdsFields.createStream(this.innerApiCalls.searchGoogleAdsFields, request, callSettings);
    }
    /**
     * Equivalent to `searchGoogleAdsFields`, but returns an iterable object.
     *
     ...
     *   [GoogleAdsField]{@link google.ads.googleads.v9.resources.GoogleAdsField}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/google_ads_field_service.search_google_ads_fields.js</caption>
     * region_tag:googleads_v9_generated_GoogleAdsFieldService_SearchGoogleAdsFields_async
     */
    searchGoogleAdsFieldsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchGoogleAdsFields.asyncIterate(this.innerApiCalls['searchGoogleAdsFields'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=google_ads_field_service_client.js.map