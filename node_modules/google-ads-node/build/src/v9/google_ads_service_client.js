...
exports.GoogleAdsServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/google_ads_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./google_ads_service_client_config.json");
...
class GoogleAdsServiceClient {
    /**
     * Construct an instance of GoogleAdsServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this.descriptors.stream = {
            searchStream: new this._gaxModule.StreamDescriptor(gax.StreamType.SERVER_STREAMING)
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.GoogleAdsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.googleAdsServiceStub) {
            return this.googleAdsServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.GoogleAdsService.
        this.googleAdsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.GoogleAdsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.GoogleAdsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const googleAdsServiceStubMethods = ['search', 'searchStream', 'mutate'];
        for (const methodName of googleAdsServiceStubMethods) {
            const callPromise = this.googleAdsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutate(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     * @param {google.ads.googleads.v9.enums.SummaryRowSettingEnum.SummaryRowSetting} request.summaryRowSetting
     ...
     * @returns {Stream}
     *   An object stream which emits [SearchGoogleAdsStreamResponse]{@link google.ads.googleads.v9.services.SearchGoogleAdsStreamResponse} on 'data' event.
     *   Please see the
     ...
     * @param {boolean} request.returnTotalResultsCount
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [GoogleAdsRow]{@link google.ads.googleads.v9.services.GoogleAdsRow} on 'data' event.
     ...
     *   [GoogleAdsRow]{@link google.ads.googleads.v9.services.GoogleAdsRow}. The API will be called under the hood as needed, once per the page,
...
exports.GoogleAdsServiceClient = GoogleAdsServiceClient;
//# sourceMappingURL=google_ads_service_client.js.map