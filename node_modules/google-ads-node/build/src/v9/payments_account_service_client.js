 ...
 * `src/v9/payments_account_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./payments_account_service_client_config.json");
...
class PaymentsAccountServiceClient {
    /**
     * Construct an instance of PaymentsAccountServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.PaymentsAccountService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.paymentsAccountServiceStub) {
            return this.paymentsAccountServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.PaymentsAccountService.
        this.paymentsAccountServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.PaymentsAccountService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.PaymentsAccountService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const paymentsAccountServiceStubMethods = ['listPaymentsAccounts'];
        for (const methodName of paymentsAccountServiceStubMethods) {
            const callPromise = this.paymentsAccountServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listPaymentsAccounts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.paymentsAccountServiceStub.then(stub => {
...
//# sourceMappingURL=payments_account_service_client.js.map