 ...
 * `src/v9/conversion_value_rule_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./conversion_value_rule_service_client_config.json");
...
class ConversionValueRuleServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ConversionValueRuleService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.conversionValueRuleServiceStub) {
            return this.conversionValueRuleServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ConversionValueRuleService.
        this.conversionValueRuleServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ConversionValueRuleService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ConversionValueRuleService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversionValueRuleServiceStubMethods = ['getConversionValueRule', 'mutateConversionValueRules'];
        for (const methodName of conversionValueRuleServiceStubMethods) {
            const callPromise = this.conversionValueRuleServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getConversionValueRule(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getConversionValueRule(request, options, callback);
    }
    mutateConversionValueRules(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.conversionValueRuleServiceStub.then(stub => {
...
//# sourceMappingURL=conversion_value_rule_service_client.js.map