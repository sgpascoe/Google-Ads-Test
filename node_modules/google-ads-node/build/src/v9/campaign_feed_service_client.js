...
exports.CampaignFeedServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_feed_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_feed_service_client_config.json");
...
class CampaignFeedServiceClient {
    /**
     * Construct an instance of CampaignFeedServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignFeedService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignFeedServiceStub) {
            return this.campaignFeedServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignFeedService.
        this.campaignFeedServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignFeedService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignFeedService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignFeedServiceStubMethods = ['getCampaignFeed', 'mutateCampaignFeeds'];
        for (const methodName of campaignFeedServiceStubMethods) {
            const callPromise = this.campaignFeedServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignFeed(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaignFeeds(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignFeedServiceStub.then(stub => {
...
exports.CampaignFeedServiceClient = CampaignFeedServiceClient;
//# sourceMappingURL=campaign_feed_service_client.js.map