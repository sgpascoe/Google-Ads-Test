 ...
 * `src/v9/customer_user_access_invitation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_user_access_invitation_service_client_config.json");
...
class CustomerUserAccessInvitationServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerUserAccessInvitationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerUserAccessInvitationServiceStub) {
            return this.customerUserAccessInvitationServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerUserAccessInvitationService.
        this.customerUserAccessInvitationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerUserAccessInvitationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerUserAccessInvitationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerUserAccessInvitationServiceStubMethods = ['getCustomerUserAccessInvitation', 'mutateCustomerUserAccessInvitation'];
        for (const methodName of customerUserAccessInvitationServiceStubMethods) {
            const callPromise = this.customerUserAccessInvitationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerUserAccessInvitation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomerUserAccessInvitation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerUserAccessInvitationServiceStub.then(stub => {
...
//# sourceMappingURL=customer_user_access_invitation_service_client.js.map