 ...
 * `src/v9/conversion_upload_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./conversion_upload_service_client_config.json");
...
class ConversionUploadServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ConversionUploadService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.conversionUploadServiceStub) {
            return this.conversionUploadServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ConversionUploadService.
        this.conversionUploadServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ConversionUploadService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ConversionUploadService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversionUploadServiceStubMethods = ['uploadClickConversions', 'uploadCallConversions'];
        for (const methodName of conversionUploadServiceStubMethods) {
            const callPromise = this.conversionUploadServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    uploadClickConversions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    uploadCallConversions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=conversion_upload_service_client.js.map