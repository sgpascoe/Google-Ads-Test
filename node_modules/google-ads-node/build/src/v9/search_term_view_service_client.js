...
exports.SearchTermViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/search_term_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./search_term_view_service_client_config.json");
...
class SearchTermViewServiceClient {
    /**
     * Construct an instance of SearchTermViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.SearchTermViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.searchTermViewServiceStub) {
            return this.searchTermViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.SearchTermViewService.
        this.searchTermViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.SearchTermViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.SearchTermViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const searchTermViewServiceStubMethods = ['getSearchTermView'];
        for (const methodName of searchTermViewServiceStubMethods) {
            const callPromise = this.searchTermViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getSearchTermView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getSearchTermView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.searchTermViewServiceStub.then(stub => {
...
exports.SearchTermViewServiceClient = SearchTermViewServiceClient;
//# sourceMappingURL=search_term_view_service_client.js.map