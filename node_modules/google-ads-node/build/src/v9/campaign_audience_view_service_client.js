...
exports.CampaignAudienceViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_audience_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_audience_view_service_client_config.json");
...
class CampaignAudienceViewServiceClient {
    /**
     * Construct an instance of CampaignAudienceViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignAudienceViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignAudienceViewServiceStub) {
            return this.campaignAudienceViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignAudienceViewService.
        this.campaignAudienceViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignAudienceViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignAudienceViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignAudienceViewServiceStubMethods = ['getCampaignAudienceView'];
        for (const methodName of campaignAudienceViewServiceStubMethods) {
            const callPromise = this.campaignAudienceViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignAudienceView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getCampaignAudienceView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignAudienceViewServiceStub.then(stub => {
...
exports.CampaignAudienceViewServiceClient = CampaignAudienceViewServiceClient;
//# sourceMappingURL=campaign_audience_view_service_client.js.map