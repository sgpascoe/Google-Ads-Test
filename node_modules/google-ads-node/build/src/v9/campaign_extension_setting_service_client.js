...
exports.CampaignExtensionSettingServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_extension_setting_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_extension_setting_service_client_config.json");
...
class CampaignExtensionSettingServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignExtensionSettingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignExtensionSettingServiceStub) {
            return this.campaignExtensionSettingServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignExtensionSettingService.
        this.campaignExtensionSettingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignExtensionSettingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignExtensionSettingService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignExtensionSettingServiceStubMethods = ['getCampaignExtensionSetting', 'mutateCampaignExtensionSettings'];
        for (const methodName of campaignExtensionSettingServiceStubMethods) {
            const callPromise = this.campaignExtensionSettingServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignExtensionSetting(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaignExtensionSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignExtensionSettingServiceStub.then(stub => {
...
exports.CampaignExtensionSettingServiceClient = CampaignExtensionSettingServiceClient;
//# sourceMappingURL=campaign_extension_setting_service_client.js.map