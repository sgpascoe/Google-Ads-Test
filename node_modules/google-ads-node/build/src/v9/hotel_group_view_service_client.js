...
exports.HotelGroupViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/hotel_group_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./hotel_group_view_service_client_config.json");
...
class HotelGroupViewServiceClient {
    /**
     * Construct an instance of HotelGroupViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.HotelGroupViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.hotelGroupViewServiceStub) {
            return this.hotelGroupViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.HotelGroupViewService.
        this.hotelGroupViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.HotelGroupViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.HotelGroupViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const hotelGroupViewServiceStubMethods = ['getHotelGroupView'];
        for (const methodName of hotelGroupViewServiceStubMethods) {
            const callPromise = this.hotelGroupViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getHotelGroupView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getHotelGroupView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.hotelGroupViewServiceStub.then(stub => {
...
exports.HotelGroupViewServiceClient = HotelGroupViewServiceClient;
//# sourceMappingURL=hotel_group_view_service_client.js.map