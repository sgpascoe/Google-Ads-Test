...
exports.LandingPageViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/landing_page_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./landing_page_view_service_client_config.json");
...
class LandingPageViewServiceClient {
    /**
     * Construct an instance of LandingPageViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.LandingPageViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.landingPageViewServiceStub) {
            return this.landingPageViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.LandingPageViewService.
        this.landingPageViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.LandingPageViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.LandingPageViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const landingPageViewServiceStubMethods = ['getLandingPageView'];
        for (const methodName of landingPageViewServiceStubMethods) {
            const callPromise = this.landingPageViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getLandingPageView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getLandingPageView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.landingPageViewServiceStub.then(stub => {
...
exports.LandingPageViewServiceClient = LandingPageViewServiceClient;
//# sourceMappingURL=landing_page_view_service_client.js.map