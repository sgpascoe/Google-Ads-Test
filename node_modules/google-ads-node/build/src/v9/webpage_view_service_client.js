...
exports.WebpageViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/webpage_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./webpage_view_service_client_config.json");
 ...
 * @memberof v9
 */
class WebpageViewServiceClient {
    /**
     * Construct an instance of WebpageViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.WebpageViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.webpageViewServiceStub) {
            return this.webpageViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.WebpageViewService.
        this.webpageViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.WebpageViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.WebpageViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const webpageViewServiceStubMethods = ['getWebpageView'];
        for (const methodName of webpageViewServiceStubMethods) {
            const callPromise = this.webpageViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getWebpageView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getWebpageView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.webpageViewServiceStub.then(stub => {
...
exports.WebpageViewServiceClient = WebpageViewServiceClient;
//# sourceMappingURL=webpage_view_service_client.js.map