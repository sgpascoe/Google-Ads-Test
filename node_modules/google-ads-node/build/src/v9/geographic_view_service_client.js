...
exports.GeographicViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/geographic_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./geographic_view_service_client_config.json");
...
class GeographicViewServiceClient {
    /**
     * Construct an instance of GeographicViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.GeographicViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.geographicViewServiceStub) {
            return this.geographicViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.GeographicViewService.
        this.geographicViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.GeographicViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.GeographicViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const geographicViewServiceStubMethods = ['getGeographicView'];
        for (const methodName of geographicViewServiceStubMethods) {
            const callPromise = this.geographicViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getGeographicView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getGeographicView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.geographicViewServiceStub.then(stub => {
...
exports.GeographicViewServiceClient = GeographicViewServiceClient;
//# sourceMappingURL=geographic_view_service_client.js.map