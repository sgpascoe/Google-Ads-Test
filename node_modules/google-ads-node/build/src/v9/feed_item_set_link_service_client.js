...
exports.FeedItemSetLinkServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/feed_item_set_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./feed_item_set_link_service_client_config.json");
...
class FeedItemSetLinkServiceClient {
    /**
     * Construct an instance of FeedItemSetLinkServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.FeedItemSetLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.feedItemSetLinkServiceStub) {
            return this.feedItemSetLinkServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.FeedItemSetLinkService.
        this.feedItemSetLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.FeedItemSetLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.FeedItemSetLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const feedItemSetLinkServiceStubMethods = ['getFeedItemSetLink', 'mutateFeedItemSetLinks'];
        for (const methodName of feedItemSetLinkServiceStubMethods) {
            const callPromise = this.feedItemSetLinkServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getFeedItemSetLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateFeedItemSetLinks(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateFeedItemSetLinks(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.feedItemSetLinkServiceStub.then(stub => {
...
exports.FeedItemSetLinkServiceClient = FeedItemSetLinkServiceClient;
//# sourceMappingURL=feed_item_set_link_service_client.js.map