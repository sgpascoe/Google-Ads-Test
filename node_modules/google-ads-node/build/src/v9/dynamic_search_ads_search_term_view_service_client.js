...
exports.DynamicSearchAdsSearchTermViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/dynamic_search_ads_search_term_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./dynamic_search_ads_search_term_view_service_client_config.json");
...
class DynamicSearchAdsSearchTermViewServiceClient {
    /**
     * Construct an instance of DynamicSearchAdsSearchTermViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.DynamicSearchAdsSearchTermViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.dynamicSearchAdsSearchTermViewServiceStub) {
            return this.dynamicSearchAdsSearchTermViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.DynamicSearchAdsSearchTermViewService.
        this.dynamicSearchAdsSearchTermViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.DynamicSearchAdsSearchTermViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.DynamicSearchAdsSearchTermViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const dynamicSearchAdsSearchTermViewServiceStubMethods = ['getDynamicSearchAdsSearchTermView'];
        for (const methodName of dynamicSearchAdsSearchTermViewServiceStubMethods) {
            const callPromise = this.dynamicSearchAdsSearchTermViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDynamicSearchAdsSearchTermView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getDynamicSearchAdsSearchTermView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.dynamicSearchAdsSearchTermViewServiceStub.then(stub => {
...
exports.DynamicSearchAdsSearchTermViewServiceClient = DynamicSearchAdsSearchTermViewServiceClient;
//# sourceMappingURL=dynamic_search_ads_search_term_view_service_client.js.map