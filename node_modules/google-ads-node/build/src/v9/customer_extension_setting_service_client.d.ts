 ...
 * @memberof v9
 */
export declare class CustomerExtensionSettingServiceClient {
    private _terminated;
    private _opts;
    ...
    customerExtensionSettingServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     * Construct an instance of CustomerExtensionSettingServiceClient.
     *
     ...
     *   The first element of the array is an object representing [CustomerExtensionSetting]{@link google.ads.googleads.v9.resources.CustomerExtensionSetting}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/customer_extension_setting_service.get_customer_extension_setting.js</caption>
     * region_tag:googleads_v9_generated_CustomerExtensionSettingService_GetCustomerExtensionSetting_async
     */
    getCustomerExtensionSetting(request?: protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.resources.ICustomerExtensionSetting,
        protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest | undefined,
        {} | undefined
    ]>;
    getCustomerExtensionSetting(request: protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.resources.ICustomerExtensionSetting, protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest | null | undefined, {} | null | undefined>): void;
    getCustomerExtensionSetting(request: protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest, callback: Callback<protos.google.ads.googleads.v9.resources.ICustomerExtensionSetting, protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [MutateCustomerExtensionSettingsResponse]{@link google.ads.googleads.v9.services.MutateCustomerExtensionSettingsResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/customer_extension_setting_service.mutate_customer_extension_settings.js</caption>
     * region_tag:googleads_v9_generated_CustomerExtensionSettingService_MutateCustomerExtensionSettings_async
     */
    mutateCustomerExtensionSettings(request?: protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsResponse,
        protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest | undefined,
        {} | undefined
    ]>;
    mutateCustomerExtensionSettings(request: protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsResponse, protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest | null | undefined, {} | null | undefined>): void;
    mutateCustomerExtensionSettings(request: protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest, callback: Callback<protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsResponse, protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest | null | undefined, {} | null | undefined>): void;
    /**
