...
exports.CampaignConversionGoalServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_conversion_goal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_conversion_goal_service_client_config.json");
...
class CampaignConversionGoalServiceClient {
    /**
     * Construct an instance of CampaignConversionGoalServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignConversionGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignConversionGoalServiceStub) {
            return this.campaignConversionGoalServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignConversionGoalService.
        this.campaignConversionGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignConversionGoalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignConversionGoalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignConversionGoalServiceStubMethods = ['mutateCampaignConversionGoals'];
        for (const methodName of campaignConversionGoalServiceStubMethods) {
            const callPromise = this.campaignConversionGoalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCampaignConversionGoals(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCampaignConversionGoals(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignConversionGoalServiceStub.then(stub => {
...
exports.CampaignConversionGoalServiceClient = CampaignConversionGoalServiceClient;
//# sourceMappingURL=campaign_conversion_goal_service_client.js.map