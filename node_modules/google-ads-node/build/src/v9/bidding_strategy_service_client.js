...
exports.BiddingStrategyServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/bidding_strategy_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./bidding_strategy_service_client_config.json");
...
class BiddingStrategyServiceClient {
    /**
     * Construct an instance of BiddingStrategyServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.BiddingStrategyService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.biddingStrategyServiceStub) {
            return this.biddingStrategyServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.BiddingStrategyService.
        this.biddingStrategyServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.BiddingStrategyService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.BiddingStrategyService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const biddingStrategyServiceStubMethods = ['getBiddingStrategy', 'mutateBiddingStrategies'];
        for (const methodName of biddingStrategyServiceStubMethods) {
            const callPromise = this.biddingStrategyServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getBiddingStrategy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateBiddingStrategies(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.biddingStrategyServiceStub.then(stub => {
...
exports.BiddingStrategyServiceClient = BiddingStrategyServiceClient;
//# sourceMappingURL=bidding_strategy_service_client.js.map