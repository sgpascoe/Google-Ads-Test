...
exports.CustomerClientServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/customer_client_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_client_service_client_config.json");
...
class CustomerClientServiceClient {
    /**
     * Construct an instance of CustomerClientServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerClientService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerClientServiceStub) {
            return this.customerClientServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerClientService.
        this.customerClientServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerClientService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerClientService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerClientServiceStubMethods = ['getCustomerClient'];
        for (const methodName of customerClientServiceStubMethods) {
            const callPromise = this.customerClientServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerClient(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getCustomerClient(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerClientServiceStub.then(stub => {
...
exports.CustomerClientServiceClient = CustomerClientServiceClient;
//# sourceMappingURL=customer_client_service_client.js.map