 ...
 * `src/v9/third_party_app_analytics_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./third_party_app_analytics_link_service_client_config.json");
...
class ThirdPartyAppAnalyticsLinkServiceClient {
    /**
     * Construct an instance of ThirdPartyAppAnalyticsLinkServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ThirdPartyAppAnalyticsLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.thirdPartyAppAnalyticsLinkServiceStub) {
            return this.thirdPartyAppAnalyticsLinkServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ThirdPartyAppAnalyticsLinkService.
        this.thirdPartyAppAnalyticsLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ThirdPartyAppAnalyticsLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ThirdPartyAppAnalyticsLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const thirdPartyAppAnalyticsLinkServiceStubMethods = ['getThirdPartyAppAnalyticsLink', 'regenerateShareableLinkId'];
        for (const methodName of thirdPartyAppAnalyticsLinkServiceStubMethods) {
            const callPromise = this.thirdPartyAppAnalyticsLinkServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getThirdPartyAppAnalyticsLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    regenerateShareableLinkId(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=third_party_app_analytics_link_service_client.js.map