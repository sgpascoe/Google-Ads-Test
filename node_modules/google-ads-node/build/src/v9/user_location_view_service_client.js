...
exports.UserLocationViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/user_location_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./user_location_view_service_client_config.json");
...
class UserLocationViewServiceClient {
    /**
     * Construct an instance of UserLocationViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.UserLocationViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.userLocationViewServiceStub) {
            return this.userLocationViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.UserLocationViewService.
        this.userLocationViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.UserLocationViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.UserLocationViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const userLocationViewServiceStubMethods = ['getUserLocationView'];
        for (const methodName of userLocationViewServiceStubMethods) {
            const callPromise = this.userLocationViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getUserLocationView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getUserLocationView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.userLocationViewServiceStub.then(stub => {
...
exports.UserLocationViewServiceClient = UserLocationViewServiceClient;
//# sourceMappingURL=user_location_view_service_client.js.map