 ...
 * `src/v9/feed_item_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./feed_item_set_service_client_config.json");
...
class FeedItemSetServiceClient {
    /**
     * Construct an instance of FeedItemSetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.FeedItemSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.feedItemSetServiceStub) {
            return this.feedItemSetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.FeedItemSetService.
        this.feedItemSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.FeedItemSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.FeedItemSetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const feedItemSetServiceStubMethods = ['getFeedItemSet', 'mutateFeedItemSets'];
        for (const methodName of feedItemSetServiceStubMethods) {
            const callPromise = this.feedItemSetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getFeedItemSet(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateFeedItemSets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.feedItemSetServiceStub.then(stub => {
...
//# sourceMappingURL=feed_item_set_service_client.js.map