...
exports.CampaignBidModifierServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_bid_modifier_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_bid_modifier_service_client_config.json");
...
class CampaignBidModifierServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignBidModifierService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignBidModifierServiceStub) {
            return this.campaignBidModifierServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignBidModifierService.
        this.campaignBidModifierServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignBidModifierService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignBidModifierService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignBidModifierServiceStubMethods = ['getCampaignBidModifier', 'mutateCampaignBidModifiers'];
        for (const methodName of campaignBidModifierServiceStubMethods) {
            const callPromise = this.campaignBidModifierServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignBidModifier(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaignBidModifiers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignBidModifierServiceStub.then(stub => {
...
exports.CampaignBidModifierServiceClient = CampaignBidModifierServiceClient;
//# sourceMappingURL=campaign_bid_modifier_service_client.js.map