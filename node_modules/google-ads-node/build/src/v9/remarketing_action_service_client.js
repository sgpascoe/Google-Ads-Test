 ...
 * `src/v9/remarketing_action_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./remarketing_action_service_client_config.json");
...
class RemarketingActionServiceClient {
    /**
     * Construct an instance of RemarketingActionServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.RemarketingActionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.remarketingActionServiceStub) {
            return this.remarketingActionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.RemarketingActionService.
        this.remarketingActionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.RemarketingActionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.RemarketingActionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const remarketingActionServiceStubMethods = ['getRemarketingAction', 'mutateRemarketingActions'];
        for (const methodName of remarketingActionServiceStubMethods) {
            const callPromise = this.remarketingActionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getRemarketingAction(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateRemarketingActions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.remarketingActionServiceStub.then(stub => {
...
//# sourceMappingURL=remarketing_action_service_client.js.map