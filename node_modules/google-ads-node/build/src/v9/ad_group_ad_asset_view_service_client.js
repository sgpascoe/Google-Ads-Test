...
exports.AdGroupAdAssetViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_ad_asset_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_ad_asset_view_service_client_config.json");
...
class AdGroupAdAssetViewServiceClient {
    /**
     * Construct an instance of AdGroupAdAssetViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupAdAssetViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupAdAssetViewServiceStub) {
            return this.adGroupAdAssetViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupAdAssetViewService.
        this.adGroupAdAssetViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupAdAssetViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupAdAssetViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupAdAssetViewServiceStubMethods = ['getAdGroupAdAssetView'];
        for (const methodName of adGroupAdAssetViewServiceStubMethods) {
            const callPromise = this.adGroupAdAssetViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupAdAssetView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAdGroupAdAssetView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupAdAssetViewServiceStub.then(stub => {
...
exports.AdGroupAdAssetViewServiceClient = AdGroupAdAssetViewServiceClient;
//# sourceMappingURL=ad_group_ad_asset_view_service_client.js.map