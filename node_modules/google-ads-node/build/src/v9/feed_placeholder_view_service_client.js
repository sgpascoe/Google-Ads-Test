...
exports.FeedPlaceholderViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/feed_placeholder_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./feed_placeholder_view_service_client_config.json");
...
class FeedPlaceholderViewServiceClient {
    /**
     * Construct an instance of FeedPlaceholderViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.FeedPlaceholderViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.feedPlaceholderViewServiceStub) {
            return this.feedPlaceholderViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.FeedPlaceholderViewService.
        this.feedPlaceholderViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.FeedPlaceholderViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.FeedPlaceholderViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const feedPlaceholderViewServiceStubMethods = ['getFeedPlaceholderView'];
        for (const methodName of feedPlaceholderViewServiceStubMethods) {
            const callPromise = this.feedPlaceholderViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getFeedPlaceholderView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getFeedPlaceholderView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.feedPlaceholderViewServiceStub.then(stub => {
...
exports.FeedPlaceholderViewServiceClient = FeedPlaceholderViewServiceClient;
//# sourceMappingURL=feed_placeholder_view_service_client.js.map