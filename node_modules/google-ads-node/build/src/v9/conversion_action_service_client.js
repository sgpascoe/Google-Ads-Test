 ...
 * `src/v9/conversion_action_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./conversion_action_service_client_config.json");
...
class ConversionActionServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ConversionActionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.conversionActionServiceStub) {
            return this.conversionActionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ConversionActionService.
        this.conversionActionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ConversionActionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ConversionActionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversionActionServiceStubMethods = ['getConversionAction', 'mutateConversionActions'];
        for (const methodName of conversionActionServiceStubMethods) {
            const callPromise = this.conversionActionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getConversionAction(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateConversionActions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.conversionActionServiceStub.then(stub => {
...
//# sourceMappingURL=conversion_action_service_client.js.map