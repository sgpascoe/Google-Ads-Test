...
exports.OperatingSystemVersionConstantServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/operating_system_version_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./operating_system_version_constant_service_client_config.json");
...
class OperatingSystemVersionConstantServiceClient {
    /**
     * Construct an instance of OperatingSystemVersionConstantServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.OperatingSystemVersionConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.operatingSystemVersionConstantServiceStub) {
            return this.operatingSystemVersionConstantServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.OperatingSystemVersionConstantService.
        this.operatingSystemVersionConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.OperatingSystemVersionConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.OperatingSystemVersionConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const operatingSystemVersionConstantServiceStubMethods = ['getOperatingSystemVersionConstant'];
        for (const methodName of operatingSystemVersionConstantServiceStubMethods) {
            const callPromise = this.operatingSystemVersionConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getOperatingSystemVersionConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getOperatingSystemVersionConstant(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.operatingSystemVersionConstantServiceStub.then(stub => {
...
exports.OperatingSystemVersionConstantServiceClient = OperatingSystemVersionConstantServiceClient;
//# sourceMappingURL=operating_system_version_constant_service_client.js.map