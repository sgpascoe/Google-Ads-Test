 ...
 * `src/v9/customer_asset_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_asset_service_client_config.json");
...
class CustomerAssetServiceClient {
    /**
     * Construct an instance of CustomerAssetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerAssetServiceStub) {
            return this.customerAssetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerAssetService.
        this.customerAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerAssetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerAssetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerAssetServiceStubMethods = ['getCustomerAsset', 'mutateCustomerAssets'];
        for (const methodName of customerAssetServiceStubMethods) {
            const callPromise = this.customerAssetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerAsset(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomerAssets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCustomerAssets(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerAssetServiceStub.then(stub => {
...
//# sourceMappingURL=customer_asset_service_client.js.map