 ...
 * `src/v9/keyword_plan_ad_group_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./keyword_plan_ad_group_service_client_config.json");
...
class KeywordPlanAdGroupServiceClient {
    /**
     * Construct an instance of KeywordPlanAdGroupServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.KeywordPlanAdGroupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.keywordPlanAdGroupServiceStub) {
            return this.keywordPlanAdGroupServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.KeywordPlanAdGroupService.
        this.keywordPlanAdGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.KeywordPlanAdGroupService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.KeywordPlanAdGroupService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordPlanAdGroupServiceStubMethods = ['getKeywordPlanAdGroup', 'mutateKeywordPlanAdGroups'];
        for (const methodName of keywordPlanAdGroupServiceStubMethods) {
            const callPromise = this.keywordPlanAdGroupServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getKeywordPlanAdGroup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateKeywordPlanAdGroups(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateKeywordPlanAdGroups(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.keywordPlanAdGroupServiceStub.then(stub => {
...
//# sourceMappingURL=keyword_plan_ad_group_service_client.js.map