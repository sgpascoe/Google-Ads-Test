...
exports.AdGroupCustomizerServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_customizer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_customizer_service_client_config.json");
 ...
 * @memberof v9
 */
class AdGroupCustomizerServiceClient {
    /**
     * Construct an instance of AdGroupCustomizerServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupCustomizerServiceStub) {
            return this.adGroupCustomizerServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupCustomizerService.
        this.adGroupCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupCustomizerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupCustomizerService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupCustomizerServiceStubMethods = ['mutateAdGroupCustomizers'];
        for (const methodName of adGroupCustomizerServiceStubMethods) {
            const callPromise = this.adGroupCustomizerServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateAdGroupCustomizers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAdGroupCustomizers(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupCustomizerServiceStub.then(stub => {
...
exports.AdGroupCustomizerServiceClient = AdGroupCustomizerServiceClient;
//# sourceMappingURL=ad_group_customizer_service_client.js.map