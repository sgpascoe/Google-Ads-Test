 ...
 * `src/v9/keyword_plan_ad_group_keyword_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./keyword_plan_ad_group_keyword_service_client_config.json");
...
class KeywordPlanAdGroupKeywordServiceClient {
    /**
     * Construct an instance of KeywordPlanAdGroupKeywordServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.KeywordPlanAdGroupKeywordService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.keywordPlanAdGroupKeywordServiceStub) {
            return this.keywordPlanAdGroupKeywordServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.KeywordPlanAdGroupKeywordService.
        this.keywordPlanAdGroupKeywordServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.KeywordPlanAdGroupKeywordService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.KeywordPlanAdGroupKeywordService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordPlanAdGroupKeywordServiceStubMethods = ['getKeywordPlanAdGroupKeyword', 'mutateKeywordPlanAdGroupKeywords'];
        for (const methodName of keywordPlanAdGroupKeywordServiceStubMethods) {
            const callPromise = this.keywordPlanAdGroupKeywordServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getKeywordPlanAdGroupKeyword(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateKeywordPlanAdGroupKeywords(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=keyword_plan_ad_group_keyword_service_client.js.map