...
exports.CarrierConstantServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/carrier_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./carrier_constant_service_client_config.json");
...
class CarrierConstantServiceClient {
    /**
     * Construct an instance of CarrierConstantServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CarrierConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.carrierConstantServiceStub) {
            return this.carrierConstantServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CarrierConstantService.
        this.carrierConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CarrierConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CarrierConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const carrierConstantServiceStubMethods = ['getCarrierConstant'];
        for (const methodName of carrierConstantServiceStubMethods) {
            const callPromise = this.carrierConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCarrierConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getCarrierConstant(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.carrierConstantServiceStub.then(stub => {
...
exports.CarrierConstantServiceClient = CarrierConstantServiceClient;
//# sourceMappingURL=carrier_constant_service_client.js.map