...
exports.AdGroupAdLabelServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_ad_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_ad_label_service_client_config.json");
...
class AdGroupAdLabelServiceClient {
    /**
     * Construct an instance of AdGroupAdLabelServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupAdLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupAdLabelServiceStub) {
            return this.adGroupAdLabelServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupAdLabelService.
        this.adGroupAdLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupAdLabelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupAdLabelService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupAdLabelServiceStubMethods = ['getAdGroupAdLabel', 'mutateAdGroupAdLabels'];
        for (const methodName of adGroupAdLabelServiceStubMethods) {
            const callPromise = this.adGroupAdLabelServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupAdLabel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroupAdLabels(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupAdLabelServiceStub.then(stub => {
...
exports.AdGroupAdLabelServiceClient = AdGroupAdLabelServiceClient;
//# sourceMappingURL=ad_group_ad_label_service_client.js.map