...
exports.CampaignCriterionServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_criterion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_criterion_service_client_config.json");
...
class CampaignCriterionServiceClient {
    /**
     * Construct an instance of CampaignCriterionServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignCriterionServiceStub) {
            return this.campaignCriterionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignCriterionService.
        this.campaignCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignCriterionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignCriterionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignCriterionServiceStubMethods = ['getCampaignCriterion', 'mutateCampaignCriteria'];
        for (const methodName of campaignCriterionServiceStubMethods) {
            const callPromise = this.campaignCriterionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignCriterion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaignCriteria(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCampaignCriteria(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignCriterionServiceStub.then(stub => {
...
exports.CampaignCriterionServiceClient = CampaignCriterionServiceClient;
//# sourceMappingURL=campaign_criterion_service_client.js.map