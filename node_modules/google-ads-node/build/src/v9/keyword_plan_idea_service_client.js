 ...
 * `src/v9/keyword_plan_idea_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./keyword_plan_idea_service_client_config.json");
...
class KeywordPlanIdeaServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            generateKeywordIdeas: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'results')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.KeywordPlanIdeaService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.keywordPlanIdeaServiceStub) {
            return this.keywordPlanIdeaServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.KeywordPlanIdeaService.
        this.keywordPlanIdeaServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.KeywordPlanIdeaService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.KeywordPlanIdeaService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordPlanIdeaServiceStubMethods = ['generateKeywordIdeas'];
        for (const methodName of keywordPlanIdeaServiceStubMethods) {
            const callPromise = this.keywordPlanIdeaServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    generateKeywordIdeas(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     * @param {google.ads.googleads.v9.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork} request.keyword_planNetwork
     *   Targeting network.
     ...
     * @param {google.ads.googleads.v9.services.KeywordAndUrlSeed} request.keywordAndUrlSeed
     *   A Keyword and a specific Url to generate ideas from
     *   e.g. cars, www.example.com/cars.
     * @param {google.ads.googleads.v9.services.KeywordSeed} request.keywordSeed
     *   A Keyword or phrase to generate ideas from, e.g. cars.
     * @param {google.ads.googleads.v9.services.UrlSeed} request.urlSeed
     *   A specific url to generate ideas from, e.g. www.example.com/cars.
     * @param {google.ads.googleads.v9.services.SiteSeed} request.siteSeed
     *   The site to generate ideas from, e.g. www.example.com.
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [GenerateKeywordIdeaResult]{@link google.ads.googleads.v9.services.GenerateKeywordIdeaResult} on 'data' event.
     ...
     */
    generateKeywordIdeasStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        return this.descriptors.page.generateKeywordIdeas.createStream(this.innerApiCalls.generateKeywordIdeas, request, callSettings);
    }
    /**
     ...
     *   [GenerateKeywordIdeaResult]{@link google.ads.googleads.v9.services.GenerateKeywordIdeaResult}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/keyword_plan_idea_service.generate_keyword_ideas.js</caption>
     * region_tag:googleads_v9_generated_KeywordPlanIdeaService_GenerateKeywordIdeas_async
     */
    generateKeywordIdeasAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.generateKeywordIdeas.asyncIterate(this.innerApiCalls['generateKeywordIdeas'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=keyword_plan_idea_service_client.js.map