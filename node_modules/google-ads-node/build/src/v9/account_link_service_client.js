 ...
 * `src/v9/account_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./account_link_service_client_config.json");
...
class AccountLinkServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AccountLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.accountLinkServiceStub) {
            return this.accountLinkServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AccountLinkService.
        this.accountLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AccountLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AccountLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const accountLinkServiceStubMethods = ['getAccountLink', 'createAccountLink', 'mutateAccountLink'];
        for (const methodName of accountLinkServiceStubMethods) {
            const callPromise = this.accountLinkServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAccountLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createAccountLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    mutateAccountLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.accountLinkServiceStub.then(stub => {
...
//# sourceMappingURL=account_link_service_client.js.map