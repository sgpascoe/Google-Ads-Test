...
exports.AssetSetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/asset_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./asset_set_service_client_config.json");
 ...
 * @memberof v9
 */
class AssetSetServiceClient {
    /**
     * Construct an instance of AssetSetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AssetSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.assetSetServiceStub) {
            return this.assetSetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AssetSetService.
        this.assetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AssetSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AssetSetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const assetSetServiceStubMethods = ['mutateAssetSets'];
        for (const methodName of assetSetServiceStubMethods) {
            const callPromise = this.assetSetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateAssetSets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAssetSets(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.assetSetServiceStub.then(stub => {
...
exports.AssetSetServiceClient = AssetSetServiceClient;
//# sourceMappingURL=asset_set_service_client.js.map