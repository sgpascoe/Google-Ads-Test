...
exports.AdGroupAudienceViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_audience_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_audience_view_service_client_config.json");
...
class AdGroupAudienceViewServiceClient {
    /**
     * Construct an instance of AdGroupAudienceViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupAudienceViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupAudienceViewServiceStub) {
            return this.adGroupAudienceViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupAudienceViewService.
        this.adGroupAudienceViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupAudienceViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupAudienceViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupAudienceViewServiceStubMethods = ['getAdGroupAudienceView'];
        for (const methodName of adGroupAudienceViewServiceStubMethods) {
            const callPromise = this.adGroupAudienceViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupAudienceView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAdGroupAudienceView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupAudienceViewServiceStub.then(stub => {
...
exports.AdGroupAudienceViewServiceClient = AdGroupAudienceViewServiceClient;
//# sourceMappingURL=ad_group_audience_view_service_client.js.map