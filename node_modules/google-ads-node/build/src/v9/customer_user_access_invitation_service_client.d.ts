 ...
 * @memberof v9
 */
export declare class CustomerUserAccessInvitationServiceClient {
    private _terminated;
    private _opts;
    ...
    customerUserAccessInvitationServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     * Construct an instance of CustomerUserAccessInvitationServiceClient.
     *
     ...
     *   The first element of the array is an object representing [CustomerUserAccessInvitation]{@link google.ads.googleads.v9.resources.CustomerUserAccessInvitation}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/customer_user_access_invitation_service.get_customer_user_access_invitation.js</caption>
     * region_tag:googleads_v9_generated_CustomerUserAccessInvitationService_GetCustomerUserAccessInvitation_async
     */
    getCustomerUserAccessInvitation(request?: protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.resources.ICustomerUserAccessInvitation,
        protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest | undefined,
        {} | undefined
    ]>;
    getCustomerUserAccessInvitation(request: protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.resources.ICustomerUserAccessInvitation, protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest | null | undefined, {} | null | undefined>): void;
    getCustomerUserAccessInvitation(request: protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest, callback: Callback<protos.google.ads.googleads.v9.resources.ICustomerUserAccessInvitation, protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * @param {google.ads.googleads.v9.services.CustomerUserAccessInvitationOperation} request.operation
     *   Required. The operation to perform on the access invitation
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [MutateCustomerUserAccessInvitationResponse]{@link google.ads.googleads.v9.services.MutateCustomerUserAccessInvitationResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/customer_user_access_invitation_service.mutate_customer_user_access_invitation.js</caption>
     * region_tag:googleads_v9_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async
     */
    mutateCustomerUserAccessInvitation(request?: protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationResponse,
        protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest | undefined,
        {} | undefined
    ]>;
    mutateCustomerUserAccessInvitation(request: protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationResponse, protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest | null | undefined, {} | null | undefined>): void;
    mutateCustomerUserAccessInvitation(request: protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest, callback: Callback<protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationResponse, protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest | null | undefined, {} | null | undefined>): void;
    /**
