...
exports.UserInterestServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/user_interest_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./user_interest_service_client_config.json");
...
class UserInterestServiceClient {
    /**
     * Construct an instance of UserInterestServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.UserInterestService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.userInterestServiceStub) {
            return this.userInterestServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.UserInterestService.
        this.userInterestServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.UserInterestService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.UserInterestService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const userInterestServiceStubMethods = ['getUserInterest'];
        for (const methodName of userInterestServiceStubMethods) {
            const callPromise = this.userInterestServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getUserInterest(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getUserInterest(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.userInterestServiceStub.then(stub => {
...
exports.UserInterestServiceClient = UserInterestServiceClient;
//# sourceMappingURL=user_interest_service_client.js.map