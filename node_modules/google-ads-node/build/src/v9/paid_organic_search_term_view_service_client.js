...
exports.PaidOrganicSearchTermViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/paid_organic_search_term_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./paid_organic_search_term_view_service_client_config.json");
...
class PaidOrganicSearchTermViewServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.PaidOrganicSearchTermViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.paidOrganicSearchTermViewServiceStub) {
            return this.paidOrganicSearchTermViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.PaidOrganicSearchTermViewService.
        this.paidOrganicSearchTermViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.PaidOrganicSearchTermViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.PaidOrganicSearchTermViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const paidOrganicSearchTermViewServiceStubMethods = ['getPaidOrganicSearchTermView'];
        for (const methodName of paidOrganicSearchTermViewServiceStubMethods) {
            const callPromise = this.paidOrganicSearchTermViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getPaidOrganicSearchTermView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getPaidOrganicSearchTermView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.paidOrganicSearchTermViewServiceStub.then(stub => {
...
exports.PaidOrganicSearchTermViewServiceClient = PaidOrganicSearchTermViewServiceClient;
//# sourceMappingURL=paid_organic_search_term_view_service_client.js.map