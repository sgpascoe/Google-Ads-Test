...
exports.TopicConstantServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/topic_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./topic_constant_service_client_config.json");
...
class TopicConstantServiceClient {
    /**
     * Construct an instance of TopicConstantServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.TopicConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.topicConstantServiceStub) {
            return this.topicConstantServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.TopicConstantService.
        this.topicConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.TopicConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.TopicConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const topicConstantServiceStubMethods = ['getTopicConstant'];
        for (const methodName of topicConstantServiceStubMethods) {
            const callPromise = this.topicConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getTopicConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getTopicConstant(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.topicConstantServiceStub.then(stub => {
...
exports.TopicConstantServiceClient = TopicConstantServiceClient;
//# sourceMappingURL=topic_constant_service_client.js.map