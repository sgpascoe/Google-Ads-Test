...
exports.LabelServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./label_service_client_config.json");
...
class LabelServiceClient {
    /**
     * Construct an instance of LabelServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.LabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.labelServiceStub) {
            return this.labelServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.LabelService.
        this.labelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.LabelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.LabelService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const labelServiceStubMethods = ['getLabel', 'mutateLabels'];
        for (const methodName of labelServiceStubMethods) {
            const callPromise = this.labelServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getLabel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateLabels(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.labelServiceStub.then(stub => {
...
//# sourceMappingURL=label_service_client.js.map