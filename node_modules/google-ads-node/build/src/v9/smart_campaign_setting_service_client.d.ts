 ...
 * @memberof v9
 */
export declare class SmartCampaignSettingServiceClient {
    private _terminated;
    private _opts;
    ...
    smartCampaignSettingServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     */
    getSmartCampaignSetting(request?: protos.google.ads.googleads.v9.services.IGetSmartCampaignSettingRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.resources.ISmartCampaignSetting,
        protos.google.ads.googleads.v9.services.IGetSmartCampaignSettingRequest | undefined,
        {} | undefined
    ]>;
    getSmartCampaignSetting(request: protos.google.ads.googleads.v9.services.IGetSmartCampaignSettingRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.resources.ISmartCampaignSetting, protos.google.ads.googleads.v9.services.IGetSmartCampaignSettingRequest | null | undefined, {} | null | undefined>): void;
    getSmartCampaignSetting(request: protos.google.ads.googleads.v9.services.IGetSmartCampaignSettingRequest, callback: Callback<protos.google.ads.googleads.v9.resources.ISmartCampaignSetting, protos.google.ads.googleads.v9.services.IGetSmartCampaignSettingRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [MutateSmartCampaignSettingsResponse]{@link google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     ...
     */
    mutateSmartCampaignSettings(request?: protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsResponse,
        protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsRequest | undefined,
        {} | undefined
    ]>;
    mutateSmartCampaignSettings(request: protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsResponse, protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsRequest | null | undefined, {} | null | undefined>): void;
    mutateSmartCampaignSettings(request: protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsRequest, callback: Callback<protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsResponse, protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsRequest | null | undefined, {} | null | undefined>): void;
    /**
