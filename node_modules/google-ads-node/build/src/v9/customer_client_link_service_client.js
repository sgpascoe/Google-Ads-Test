 ...
 * `src/v9/customer_client_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_client_link_service_client_config.json");
...
class CustomerClientLinkServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerClientLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerClientLinkServiceStub) {
            return this.customerClientLinkServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerClientLinkService.
        this.customerClientLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerClientLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerClientLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerClientLinkServiceStubMethods = ['getCustomerClientLink', 'mutateCustomerClientLink'];
        for (const methodName of customerClientLinkServiceStubMethods) {
            const callPromise = this.customerClientLinkServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerClientLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomerClientLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerClientLinkServiceStub.then(stub => {
...
//# sourceMappingURL=customer_client_link_service_client.js.map