...
exports.BiddingDataExclusionServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/bidding_data_exclusion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./bidding_data_exclusion_service_client_config.json");
...
class BiddingDataExclusionServiceClient {
    /**
     * Construct an instance of BiddingDataExclusionServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.BiddingDataExclusionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.biddingDataExclusionServiceStub) {
            return this.biddingDataExclusionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.BiddingDataExclusionService.
        this.biddingDataExclusionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.BiddingDataExclusionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.BiddingDataExclusionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const biddingDataExclusionServiceStubMethods = ['getBiddingDataExclusion', 'mutateBiddingDataExclusions'];
        for (const methodName of biddingDataExclusionServiceStubMethods) {
            const callPromise = this.biddingDataExclusionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getBiddingDataExclusion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateBiddingDataExclusions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.biddingDataExclusionServiceStub.then(stub => {
...
exports.BiddingDataExclusionServiceClient = BiddingDataExclusionServiceClient;
//# sourceMappingURL=bidding_data_exclusion_service_client.js.map