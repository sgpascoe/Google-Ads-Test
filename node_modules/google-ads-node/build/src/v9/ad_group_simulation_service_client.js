...
exports.AdGroupSimulationServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_simulation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_simulation_service_client_config.json");
...
class AdGroupSimulationServiceClient {
    /**
     * Construct an instance of AdGroupSimulationServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupSimulationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupSimulationServiceStub) {
            return this.adGroupSimulationServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupSimulationService.
        this.adGroupSimulationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupSimulationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupSimulationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupSimulationServiceStubMethods = ['getAdGroupSimulation'];
        for (const methodName of adGroupSimulationServiceStubMethods) {
            const callPromise = this.adGroupSimulationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupSimulation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAdGroupSimulation(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupSimulationServiceStub.then(stub => {
...
exports.AdGroupSimulationServiceClient = AdGroupSimulationServiceClient;
//# sourceMappingURL=ad_group_simulation_service_client.js.map