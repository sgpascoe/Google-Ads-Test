...
exports.AdGroupCriterionSimulationServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_criterion_simulation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_criterion_simulation_service_client_config.json");
...
class AdGroupCriterionSimulationServiceClient {
    /**
     * Construct an instance of AdGroupCriterionSimulationServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupCriterionSimulationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupCriterionSimulationServiceStub) {
            return this.adGroupCriterionSimulationServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupCriterionSimulationService.
        this.adGroupCriterionSimulationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupCriterionSimulationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupCriterionSimulationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupCriterionSimulationServiceStubMethods = ['getAdGroupCriterionSimulation'];
        for (const methodName of adGroupCriterionSimulationServiceStubMethods) {
            const callPromise = this.adGroupCriterionSimulationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupCriterionSimulation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAdGroupCriterionSimulation(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupCriterionSimulationServiceStub.then(stub => {
...
exports.AdGroupCriterionSimulationServiceClient = AdGroupCriterionSimulationServiceClient;
//# sourceMappingURL=ad_group_criterion_simulation_service_client.js.map