 ...
 * `src/v9/reach_plan_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./reach_plan_service_client_config.json");
...
class ReachPlanServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ReachPlanService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.reachPlanServiceStub) {
            return this.reachPlanServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ReachPlanService.
        this.reachPlanServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ReachPlanService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ReachPlanService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const reachPlanServiceStubMethods = ['listPlannableLocations', 'listPlannableProducts', 'generateProductMixIdeas', 'generateReachForecast'];
        for (const methodName of reachPlanServiceStubMethods) {
            const callPromise = this.reachPlanServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listPlannableLocations(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    listPlannableProducts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    generateProductMixIdeas(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    generateReachForecast(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.reachPlanServiceStub.then(stub => {
...
//# sourceMappingURL=reach_plan_service_client.js.map