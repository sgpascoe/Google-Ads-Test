...
exports.SmartCampaignSearchTermViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/smart_campaign_search_term_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./smart_campaign_search_term_view_service_client_config.json");
 ...
 * @memberof v9
 */
class SmartCampaignSearchTermViewServiceClient {
    /**
     * Construct an instance of SmartCampaignSearchTermViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.SmartCampaignSearchTermViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.smartCampaignSearchTermViewServiceStub) {
            return this.smartCampaignSearchTermViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.SmartCampaignSearchTermViewService.
        this.smartCampaignSearchTermViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.SmartCampaignSearchTermViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.SmartCampaignSearchTermViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const smartCampaignSearchTermViewServiceStubMethods = ['getSmartCampaignSearchTermView'];
        for (const methodName of smartCampaignSearchTermViewServiceStubMethods) {
            const callPromise = this.smartCampaignSearchTermViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getSmartCampaignSearchTermView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getSmartCampaignSearchTermView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.smartCampaignSearchTermViewServiceStub.then(stub => {
...
exports.SmartCampaignSearchTermViewServiceClient = SmartCampaignSearchTermViewServiceClient;
//# sourceMappingURL=smart_campaign_search_term_view_service_client.js.map