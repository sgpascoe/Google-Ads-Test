 ...
 * `src/v9/custom_interest_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./custom_interest_service_client_config.json");
...
class CustomInterestServiceClient {
    /**
     * Construct an instance of CustomInterestServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomInterestService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customInterestServiceStub) {
            return this.customInterestServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomInterestService.
        this.customInterestServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomInterestService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomInterestService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customInterestServiceStubMethods = ['getCustomInterest', 'mutateCustomInterests'];
        for (const methodName of customInterestServiceStubMethods) {
            const callPromise = this.customInterestServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomInterest(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomInterests(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCustomInterests(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customInterestServiceStub.then(stub => {
...
//# sourceMappingURL=custom_interest_service_client.js.map