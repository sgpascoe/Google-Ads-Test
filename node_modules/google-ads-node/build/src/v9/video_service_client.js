...
exports.VideoServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/video_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./video_service_client_config.json");
...
class VideoServiceClient {
    /**
     * Construct an instance of VideoServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.VideoService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.videoServiceStub) {
            return this.videoServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.VideoService.
        this.videoServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.VideoService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.VideoService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const videoServiceStubMethods = ['getVideo'];
        for (const methodName of videoServiceStubMethods) {
            const callPromise = this.videoServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getVideo(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getVideo(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.videoServiceStub.then(stub => {
...
//# sourceMappingURL=video_service_client.js.map