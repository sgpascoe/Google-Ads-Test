 ...
 * `src/v9/feed_mapping_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./feed_mapping_service_client_config.json");
...
class FeedMappingServiceClient {
    /**
     * Construct an instance of FeedMappingServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.FeedMappingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.feedMappingServiceStub) {
            return this.feedMappingServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.FeedMappingService.
        this.feedMappingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.FeedMappingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.FeedMappingService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const feedMappingServiceStubMethods = ['getFeedMapping', 'mutateFeedMappings'];
        for (const methodName of feedMappingServiceStubMethods) {
            const callPromise = this.feedMappingServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getFeedMapping(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateFeedMappings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateFeedMappings(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.feedMappingServiceStub.then(stub => {
...
//# sourceMappingURL=feed_mapping_service_client.js.map