...
exports.CampaignAssetSetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_asset_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_asset_set_service_client_config.json");
 ...
 * @memberof v9
 */
class CampaignAssetSetServiceClient {
    /**
     * Construct an instance of CampaignAssetSetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignAssetSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignAssetSetServiceStub) {
            return this.campaignAssetSetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignAssetSetService.
        this.campaignAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignAssetSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignAssetSetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignAssetSetServiceStubMethods = ['mutateCampaignAssetSets'];
        for (const methodName of campaignAssetSetServiceStubMethods) {
            const callPromise = this.campaignAssetSetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCampaignAssetSets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCampaignAssetSets(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignAssetSetServiceStub.then(stub => {
...
exports.CampaignAssetSetServiceClient = CampaignAssetSetServiceClient;
//# sourceMappingURL=campaign_asset_set_service_client.js.map