...
exports.LocationViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/location_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./location_view_service_client_config.json");
...
class LocationViewServiceClient {
    /**
     * Construct an instance of LocationViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.LocationViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.locationViewServiceStub) {
            return this.locationViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.LocationViewService.
        this.locationViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.LocationViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.LocationViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const locationViewServiceStubMethods = ['getLocationView'];
        for (const methodName of locationViewServiceStubMethods) {
            const callPromise = this.locationViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getLocationView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getLocationView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.locationViewServiceStub.then(stub => {
...
exports.LocationViewServiceClient = LocationViewServiceClient;
//# sourceMappingURL=location_view_service_client.js.map