...
exports.FeedItemTargetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/feed_item_target_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./feed_item_target_service_client_config.json");
...
class FeedItemTargetServiceClient {
    /**
     * Construct an instance of FeedItemTargetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.FeedItemTargetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.feedItemTargetServiceStub) {
            return this.feedItemTargetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.FeedItemTargetService.
        this.feedItemTargetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.FeedItemTargetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.FeedItemTargetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const feedItemTargetServiceStubMethods = ['getFeedItemTarget', 'mutateFeedItemTargets'];
        for (const methodName of feedItemTargetServiceStubMethods) {
            const callPromise = this.feedItemTargetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getFeedItemTarget(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getFeedItemTarget(request, options, callback);
    }
    mutateFeedItemTargets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.feedItemTargetServiceStub.then(stub => {
...
exports.FeedItemTargetServiceClient = FeedItemTargetServiceClient;
//# sourceMappingURL=feed_item_target_service_client.js.map