...
exports.LanguageConstantServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/language_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./language_constant_service_client_config.json");
...
class LanguageConstantServiceClient {
    /**
     * Construct an instance of LanguageConstantServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.LanguageConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.languageConstantServiceStub) {
            return this.languageConstantServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.LanguageConstantService.
        this.languageConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.LanguageConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.LanguageConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const languageConstantServiceStubMethods = ['getLanguageConstant'];
        for (const methodName of languageConstantServiceStubMethods) {
            const callPromise = this.languageConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getLanguageConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getLanguageConstant(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.languageConstantServiceStub.then(stub => {
...
exports.LanguageConstantServiceClient = LanguageConstantServiceClient;
//# sourceMappingURL=language_constant_service_client.js.map