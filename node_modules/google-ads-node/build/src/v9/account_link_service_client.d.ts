 ...
 * @memberof v9
 */
export declare class AccountLinkServiceClient {
    private _terminated;
    private _opts;
    ...
    accountLinkServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     * Construct an instance of AccountLinkServiceClient.
     *
     ...
     *   The first element of the array is an object representing [AccountLink]{@link google.ads.googleads.v9.resources.AccountLink}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/account_link_service.get_account_link.js</caption>
     * region_tag:googleads_v9_generated_AccountLinkService_GetAccountLink_async
     */
    getAccountLink(request?: protos.google.ads.googleads.v9.services.IGetAccountLinkRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.resources.IAccountLink,
        protos.google.ads.googleads.v9.services.IGetAccountLinkRequest | undefined,
        {} | undefined
    ]>;
    getAccountLink(request: protos.google.ads.googleads.v9.services.IGetAccountLinkRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.resources.IAccountLink, protos.google.ads.googleads.v9.services.IGetAccountLinkRequest | null | undefined, {} | null | undefined>): void;
    getAccountLink(request: protos.google.ads.googleads.v9.services.IGetAccountLinkRequest, callback: Callback<protos.google.ads.googleads.v9.resources.IAccountLink, protos.google.ads.googleads.v9.services.IGetAccountLinkRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * @param {google.ads.googleads.v9.resources.AccountLink} request.accountLink
     *   Required. The account link to be created.
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [CreateAccountLinkResponse]{@link google.ads.googleads.v9.services.CreateAccountLinkResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/account_link_service.create_account_link.js</caption>
     * region_tag:googleads_v9_generated_AccountLinkService_CreateAccountLink_async
     */
    createAccountLink(request?: protos.google.ads.googleads.v9.services.ICreateAccountLinkRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.services.ICreateAccountLinkResponse,
        protos.google.ads.googleads.v9.services.ICreateAccountLinkRequest | undefined,
        {} | undefined
    ]>;
    createAccountLink(request: protos.google.ads.googleads.v9.services.ICreateAccountLinkRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.services.ICreateAccountLinkResponse, protos.google.ads.googleads.v9.services.ICreateAccountLinkRequest | null | undefined, {} | null | undefined>): void;
    createAccountLink(request: protos.google.ads.googleads.v9.services.ICreateAccountLinkRequest, callback: Callback<protos.google.ads.googleads.v9.services.ICreateAccountLinkResponse, protos.google.ads.googleads.v9.services.ICreateAccountLinkRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * @param {google.ads.googleads.v9.services.AccountLinkOperation} request.operation
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [MutateAccountLinkResponse]{@link google.ads.googleads.v9.services.MutateAccountLinkResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v9/account_link_service.mutate_account_link.js</caption>
     * region_tag:googleads_v9_generated_AccountLinkService_MutateAccountLink_async
     */
    mutateAccountLink(request?: protos.google.ads.googleads.v9.services.IMutateAccountLinkRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v9.services.IMutateAccountLinkResponse,
        protos.google.ads.googleads.v9.services.IMutateAccountLinkRequest | undefined,
        {} | undefined
    ]>;
    mutateAccountLink(request: protos.google.ads.googleads.v9.services.IMutateAccountLinkRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v9.services.IMutateAccountLinkResponse, protos.google.ads.googleads.v9.services.IMutateAccountLinkRequest | null | undefined, {} | null | undefined>): void;
    mutateAccountLink(request: protos.google.ads.googleads.v9.services.IMutateAccountLinkRequest, callback: Callback<protos.google.ads.googleads.v9.services.IMutateAccountLinkResponse, protos.google.ads.googleads.v9.services.IMutateAccountLinkRequest | null | undefined, {} | null | undefined>): void;
    /**
