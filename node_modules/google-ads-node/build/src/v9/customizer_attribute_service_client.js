...
exports.CustomizerAttributeServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/customizer_attribute_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customizer_attribute_service_client_config.json");
...
class CustomizerAttributeServiceClient {
    /**
     * Construct an instance of CustomizerAttributeServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomizerAttributeService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customizerAttributeServiceStub) {
            return this.customizerAttributeServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomizerAttributeService.
        this.customizerAttributeServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomizerAttributeService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomizerAttributeService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customizerAttributeServiceStubMethods = ['mutateCustomizerAttributes'];
        for (const methodName of customizerAttributeServiceStubMethods) {
            const callPromise = this.customizerAttributeServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCustomizerAttributes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
...
exports.CustomizerAttributeServiceClient = CustomizerAttributeServiceClient;
//# sourceMappingURL=customizer_attribute_service_client.js.map