...
exports.MobileAppCategoryConstantServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/mobile_app_category_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./mobile_app_category_constant_service_client_config.json");
...
class MobileAppCategoryConstantServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.MobileAppCategoryConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.ads.googleads.v9.services.MobileAppCategoryConstantService.
        this.mobileAppCategoryConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.MobileAppCategoryConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.MobileAppCategoryConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const mobileAppCategoryConstantServiceStubMethods = ['getMobileAppCategoryConstant'];
        for (const methodName of mobileAppCategoryConstantServiceStubMethods) {
            const callPromise = this.mobileAppCategoryConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getMobileAppCategoryConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
...
exports.MobileAppCategoryConstantServiceClient = MobileAppCategoryConstantServiceClient;
//# sourceMappingURL=mobile_app_category_constant_service_client.js.map