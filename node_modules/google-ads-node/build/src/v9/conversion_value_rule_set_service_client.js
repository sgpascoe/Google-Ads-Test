 ...
 * `src/v9/conversion_value_rule_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./conversion_value_rule_set_service_client_config.json");
...
class ConversionValueRuleSetServiceClient {
    /**
     * Construct an instance of ConversionValueRuleSetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ConversionValueRuleSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.conversionValueRuleSetServiceStub) {
            return this.conversionValueRuleSetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ConversionValueRuleSetService.
        this.conversionValueRuleSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ConversionValueRuleSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ConversionValueRuleSetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversionValueRuleSetServiceStubMethods = ['getConversionValueRuleSet', 'mutateConversionValueRuleSets'];
        for (const methodName of conversionValueRuleSetServiceStubMethods) {
            const callPromise = this.conversionValueRuleSetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getConversionValueRuleSet(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateConversionValueRuleSets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateConversionValueRuleSets(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.conversionValueRuleSetServiceStub.then(stub => {
...
//# sourceMappingURL=conversion_value_rule_set_service_client.js.map