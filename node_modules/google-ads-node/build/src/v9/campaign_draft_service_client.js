 ...
 * `src/v9/campaign_draft_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_draft_service_client_config.json");
...
class CampaignDraftServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listCampaignDraftAsyncErrors: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'errors')
        };
        ...
        const promoteCampaignDraftResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const promoteCampaignDraftMetadata = protoFilesRoot.lookup('.google.protobuf.Empty');
        this.descriptors.longrunning = {
            promoteCampaignDraft: new this._gaxModule.LongrunningDescriptor(this.operationsClient, promoteCampaignDraftResponse.decode.bind(promoteCampaignDraftResponse), promoteCampaignDraftMetadata.decode.bind(promoteCampaignDraftMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignDraftService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignDraftServiceStub) {
            return this.campaignDraftServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignDraftService.
        this.campaignDraftServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignDraftService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignDraftService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignDraftServiceStubMethods = ['getCampaignDraft', 'mutateCampaignDrafts', 'promoteCampaignDraft', 'listCampaignDraftAsyncErrors'];
        for (const methodName of campaignDraftServiceStubMethods) {
            const callPromise = this.campaignDraftServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignDraft(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaignDrafts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    promoteCampaignDraft(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkPromoteCampaignDraftProgress(name) {
    ...
    listCampaignDraftAsyncErrors(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listCampaignDraftAsyncErrorsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        return this.descriptors.page.listCampaignDraftAsyncErrors.createStream(this.innerApiCalls.listCampaignDraftAsyncErrors, request, callSettings);
    }
    /**
     ...
     */
    listCampaignDraftAsyncErrorsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listCampaignDraftAsyncErrors.asyncIterate(this.innerApiCalls['listCampaignDraftAsyncErrors'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=campaign_draft_service_client.js.map