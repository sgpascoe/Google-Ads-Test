 ...
 * `src/v9/ad_group_asset_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_asset_service_client_config.json");
...
class AdGroupAssetServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupAssetServiceStub) {
            return this.adGroupAssetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupAssetService.
        this.adGroupAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupAssetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupAssetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupAssetServiceStubMethods = ['getAdGroupAsset', 'mutateAdGroupAssets'];
        for (const methodName of adGroupAssetServiceStubMethods) {
            const callPromise = this.adGroupAssetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupAsset(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroupAssets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupAssetServiceStub.then(stub => {
...
//# sourceMappingURL=ad_group_asset_service_client.js.map