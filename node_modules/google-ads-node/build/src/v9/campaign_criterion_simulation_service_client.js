...
exports.CampaignCriterionSimulationServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_criterion_simulation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_criterion_simulation_service_client_config.json");
...
class CampaignCriterionSimulationServiceClient {
    /**
     * Construct an instance of CampaignCriterionSimulationServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignCriterionSimulationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignCriterionSimulationServiceStub) {
            return this.campaignCriterionSimulationServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignCriterionSimulationService.
        this.campaignCriterionSimulationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignCriterionSimulationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignCriterionSimulationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignCriterionSimulationServiceStubMethods = ['getCampaignCriterionSimulation'];
        for (const methodName of campaignCriterionSimulationServiceStubMethods) {
            const callPromise = this.campaignCriterionSimulationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignCriterionSimulation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getCampaignCriterionSimulation(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignCriterionSimulationServiceStub.then(stub => {
...
exports.CampaignCriterionSimulationServiceClient = CampaignCriterionSimulationServiceClient;
//# sourceMappingURL=campaign_criterion_simulation_service_client.js.map