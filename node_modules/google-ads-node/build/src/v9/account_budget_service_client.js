...
exports.AccountBudgetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/account_budget_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./account_budget_service_client_config.json");
...
class AccountBudgetServiceClient {
    /**
     * Construct an instance of AccountBudgetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AccountBudgetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.accountBudgetServiceStub) {
            return this.accountBudgetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AccountBudgetService.
        this.accountBudgetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AccountBudgetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AccountBudgetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const accountBudgetServiceStubMethods = ['getAccountBudget'];
        for (const methodName of accountBudgetServiceStubMethods) {
            const callPromise = this.accountBudgetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAccountBudget(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAccountBudget(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.accountBudgetServiceStub.then(stub => {
...
exports.AccountBudgetServiceClient = AccountBudgetServiceClient;
//# sourceMappingURL=account_budget_service_client.js.map