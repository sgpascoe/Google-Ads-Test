...
exports.KeywordViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/keyword_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./keyword_view_service_client_config.json");
...
class KeywordViewServiceClient {
    /**
     * Construct an instance of KeywordViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.KeywordViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.keywordViewServiceStub) {
            return this.keywordViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.KeywordViewService.
        this.keywordViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.KeywordViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.KeywordViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordViewServiceStubMethods = ['getKeywordView'];
        for (const methodName of keywordViewServiceStubMethods) {
            const callPromise = this.keywordViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getKeywordView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getKeywordView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.keywordViewServiceStub.then(stub => {
...
exports.KeywordViewServiceClient = KeywordViewServiceClient;
//# sourceMappingURL=keyword_view_service_client.js.map