...
exports.AdGroupCriterionCustomizerServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_criterion_customizer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_criterion_customizer_service_client_config.json");
...
class AdGroupCriterionCustomizerServiceClient {
    /**
     * Construct an instance of AdGroupCriterionCustomizerServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupCriterionCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupCriterionCustomizerServiceStub) {
            return this.adGroupCriterionCustomizerServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupCriterionCustomizerService.
        this.adGroupCriterionCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupCriterionCustomizerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupCriterionCustomizerService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupCriterionCustomizerServiceStubMethods = ['mutateAdGroupCriterionCustomizers'];
        for (const methodName of adGroupCriterionCustomizerServiceStubMethods) {
            const callPromise = this.adGroupCriterionCustomizerServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateAdGroupCriterionCustomizers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAdGroupCriterionCustomizers(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupCriterionCustomizerServiceStub.then(stub => {
...
exports.AdGroupCriterionCustomizerServiceClient = AdGroupCriterionCustomizerServiceClient;
//# sourceMappingURL=ad_group_criterion_customizer_service_client.js.map