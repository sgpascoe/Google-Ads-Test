...
exports.DetailPlacementViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/detail_placement_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./detail_placement_view_service_client_config.json");
...
class DetailPlacementViewServiceClient {
    /**
     * Construct an instance of DetailPlacementViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.DetailPlacementViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.detailPlacementViewServiceStub) {
            return this.detailPlacementViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.DetailPlacementViewService.
        this.detailPlacementViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.DetailPlacementViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.DetailPlacementViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const detailPlacementViewServiceStubMethods = ['getDetailPlacementView'];
        for (const methodName of detailPlacementViewServiceStubMethods) {
            const callPromise = this.detailPlacementViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDetailPlacementView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getDetailPlacementView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.detailPlacementViewServiceStub.then(stub => {
...
exports.DetailPlacementViewServiceClient = DetailPlacementViewServiceClient;
//# sourceMappingURL=detail_placement_view_service_client.js.map