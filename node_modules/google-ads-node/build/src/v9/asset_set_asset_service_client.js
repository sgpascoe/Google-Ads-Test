...
exports.AssetSetAssetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/asset_set_asset_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./asset_set_asset_service_client_config.json");
 ...
 * @memberof v9
 */
class AssetSetAssetServiceClient {
    /**
     * Construct an instance of AssetSetAssetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AssetSetAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.assetSetAssetServiceStub) {
            return this.assetSetAssetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AssetSetAssetService.
        this.assetSetAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AssetSetAssetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AssetSetAssetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const assetSetAssetServiceStubMethods = ['mutateAssetSetAssets'];
        for (const methodName of assetSetAssetServiceStubMethods) {
            const callPromise = this.assetSetAssetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateAssetSetAssets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAssetSetAssets(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.assetSetAssetServiceStub.then(stub => {
...
exports.AssetSetAssetServiceClient = AssetSetAssetServiceClient;
//# sourceMappingURL=asset_set_asset_service_client.js.map