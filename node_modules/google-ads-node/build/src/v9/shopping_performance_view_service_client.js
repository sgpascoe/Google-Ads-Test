...
exports.ShoppingPerformanceViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/shopping_performance_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./shopping_performance_view_service_client_config.json");
...
class ShoppingPerformanceViewServiceClient {
    /**
     * Construct an instance of ShoppingPerformanceViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ShoppingPerformanceViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.shoppingPerformanceViewServiceStub) {
            return this.shoppingPerformanceViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ShoppingPerformanceViewService.
        this.shoppingPerformanceViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ShoppingPerformanceViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ShoppingPerformanceViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const shoppingPerformanceViewServiceStubMethods = ['getShoppingPerformanceView'];
        for (const methodName of shoppingPerformanceViewServiceStubMethods) {
            const callPromise = this.shoppingPerformanceViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getShoppingPerformanceView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getShoppingPerformanceView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.shoppingPerformanceViewServiceStub.then(stub => {
...
exports.ShoppingPerformanceViewServiceClient = ShoppingPerformanceViewServiceClient;
//# sourceMappingURL=shopping_performance_view_service_client.js.map