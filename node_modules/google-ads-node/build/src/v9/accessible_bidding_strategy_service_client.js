...
exports.AccessibleBiddingStrategyServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/accessible_bidding_strategy_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./accessible_bidding_strategy_service_client_config.json");
...
class AccessibleBiddingStrategyServiceClient {
    /**
     * Construct an instance of AccessibleBiddingStrategyServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AccessibleBiddingStrategyService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.accessibleBiddingStrategyServiceStub) {
            return this.accessibleBiddingStrategyServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AccessibleBiddingStrategyService.
        this.accessibleBiddingStrategyServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AccessibleBiddingStrategyService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AccessibleBiddingStrategyService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const accessibleBiddingStrategyServiceStubMethods = ['getAccessibleBiddingStrategy'];
        for (const methodName of accessibleBiddingStrategyServiceStubMethods) {
            const callPromise = this.accessibleBiddingStrategyServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAccessibleBiddingStrategy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAccessibleBiddingStrategy(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.accessibleBiddingStrategyServiceStub.then(stub => {
...
exports.AccessibleBiddingStrategyServiceClient = AccessibleBiddingStrategyServiceClient;
//# sourceMappingURL=accessible_bidding_strategy_service_client.js.map