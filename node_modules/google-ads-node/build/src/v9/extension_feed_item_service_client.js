 ...
 * `src/v9/extension_feed_item_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./extension_feed_item_service_client_config.json");
...
class ExtensionFeedItemServiceClient {
    /**
     * Construct an instance of ExtensionFeedItemServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ExtensionFeedItemService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.extensionFeedItemServiceStub) {
            return this.extensionFeedItemServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ExtensionFeedItemService.
        this.extensionFeedItemServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ExtensionFeedItemService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ExtensionFeedItemService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const extensionFeedItemServiceStubMethods = ['getExtensionFeedItem', 'mutateExtensionFeedItems'];
        for (const methodName of extensionFeedItemServiceStubMethods) {
            const callPromise = this.extensionFeedItemServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getExtensionFeedItem(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateExtensionFeedItems(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateExtensionFeedItems(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.extensionFeedItemServiceStub.then(stub => {
...
//# sourceMappingURL=extension_feed_item_service_client.js.map