...
exports.MobileDeviceConstantServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/mobile_device_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./mobile_device_constant_service_client_config.json");
...
class MobileDeviceConstantServiceClient {
    /**
     * Construct an instance of MobileDeviceConstantServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.MobileDeviceConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.mobileDeviceConstantServiceStub) {
            return this.mobileDeviceConstantServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.MobileDeviceConstantService.
        this.mobileDeviceConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.MobileDeviceConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.MobileDeviceConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const mobileDeviceConstantServiceStubMethods = ['getMobileDeviceConstant'];
        for (const methodName of mobileDeviceConstantServiceStubMethods) {
            const callPromise = this.mobileDeviceConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getMobileDeviceConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getMobileDeviceConstant(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.mobileDeviceConstantServiceStub.then(stub => {
...
exports.MobileDeviceConstantServiceClient = MobileDeviceConstantServiceClient;
//# sourceMappingURL=mobile_device_constant_service_client.js.map