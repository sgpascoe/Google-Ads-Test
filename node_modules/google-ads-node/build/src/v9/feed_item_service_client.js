...
exports.FeedItemServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/feed_item_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./feed_item_service_client_config.json");
...
class FeedItemServiceClient {
    /**
     * Construct an instance of FeedItemServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.FeedItemService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.feedItemServiceStub) {
            return this.feedItemServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.FeedItemService.
        this.feedItemServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.FeedItemService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.FeedItemService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const feedItemServiceStubMethods = ['getFeedItem', 'mutateFeedItems'];
        for (const methodName of feedItemServiceStubMethods) {
            const callPromise = this.feedItemServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getFeedItem(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getFeedItem(request, options, callback);
    }
    mutateFeedItems(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateFeedItems(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.feedItemServiceStub.then(stub => {
...
exports.FeedItemServiceClient = FeedItemServiceClient;
//# sourceMappingURL=feed_item_service_client.js.map