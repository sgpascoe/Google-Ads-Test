 ...
 * `src/v9/customer_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_label_service_client_config.json");
...
class CustomerLabelServiceClient {
    /**
     * Construct an instance of CustomerLabelServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerLabelServiceStub) {
            return this.customerLabelServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerLabelService.
        this.customerLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerLabelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerLabelService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerLabelServiceStubMethods = ['getCustomerLabel', 'mutateCustomerLabels'];
        for (const methodName of customerLabelServiceStubMethods) {
            const callPromise = this.customerLabelServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerLabel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getCustomerLabel(request, options, callback);
    }
    mutateCustomerLabels(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCustomerLabels(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerLabelServiceStub.then(stub => {
...
//# sourceMappingURL=customer_label_service_client.js.map