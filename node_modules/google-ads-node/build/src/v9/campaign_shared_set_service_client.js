...
exports.CampaignSharedSetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_shared_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_shared_set_service_client_config.json");
...
class CampaignSharedSetServiceClient {
    /**
     * Construct an instance of CampaignSharedSetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignSharedSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignSharedSetServiceStub) {
            return this.campaignSharedSetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignSharedSetService.
        this.campaignSharedSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignSharedSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignSharedSetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignSharedSetServiceStubMethods = ['getCampaignSharedSet', 'mutateCampaignSharedSets'];
        for (const methodName of campaignSharedSetServiceStubMethods) {
            const callPromise = this.campaignSharedSetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignSharedSet(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaignSharedSets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignSharedSetServiceStub.then(stub => {
...
exports.CampaignSharedSetServiceClient = CampaignSharedSetServiceClient;
//# sourceMappingURL=campaign_shared_set_service_client.js.map