 ...
 * `src/v9/shared_criterion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./shared_criterion_service_client_config.json");
...
class SharedCriterionServiceClient {
    /**
     * Construct an instance of SharedCriterionServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.SharedCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.sharedCriterionServiceStub) {
            return this.sharedCriterionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.SharedCriterionService.
        this.sharedCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.SharedCriterionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.SharedCriterionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const sharedCriterionServiceStubMethods = ['getSharedCriterion', 'mutateSharedCriteria'];
        for (const methodName of sharedCriterionServiceStubMethods) {
            const callPromise = this.sharedCriterionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getSharedCriterion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateSharedCriteria(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateSharedCriteria(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.sharedCriterionServiceStub.then(stub => {
...
//# sourceMappingURL=shared_criterion_service_client.js.map