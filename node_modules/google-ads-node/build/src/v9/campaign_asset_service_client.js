...
exports.CampaignAssetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_asset_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_asset_service_client_config.json");
...
class CampaignAssetServiceClient {
    /**
     * Construct an instance of CampaignAssetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignAssetServiceStub) {
            return this.campaignAssetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignAssetService.
        this.campaignAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignAssetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignAssetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignAssetServiceStubMethods = ['getCampaignAsset', 'mutateCampaignAssets'];
        for (const methodName of campaignAssetServiceStubMethods) {
            const callPromise = this.campaignAssetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCampaignAsset(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCampaignAssets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCampaignAssets(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignAssetServiceStub.then(stub => {
...
exports.CampaignAssetServiceClient = CampaignAssetServiceClient;
//# sourceMappingURL=campaign_asset_service_client.js.map