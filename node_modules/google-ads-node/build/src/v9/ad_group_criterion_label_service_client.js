...
exports.AdGroupCriterionLabelServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_criterion_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_criterion_label_service_client_config.json");
...
class AdGroupCriterionLabelServiceClient {
    /**
     * Construct an instance of AdGroupCriterionLabelServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupCriterionLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupCriterionLabelServiceStub) {
            return this.adGroupCriterionLabelServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupCriterionLabelService.
        this.adGroupCriterionLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupCriterionLabelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupCriterionLabelService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupCriterionLabelServiceStubMethods = ['getAdGroupCriterionLabel', 'mutateAdGroupCriterionLabels'];
        for (const methodName of adGroupCriterionLabelServiceStubMethods) {
            const callPromise = this.adGroupCriterionLabelServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupCriterionLabel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroupCriterionLabels(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupCriterionLabelServiceStub.then(stub => {
...
exports.AdGroupCriterionLabelServiceClient = AdGroupCriterionLabelServiceClient;
//# sourceMappingURL=ad_group_criterion_label_service_client.js.map