 ...
 * `src/v9/ad_group_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_service_client_config.json");
...
class AdGroupServiceClient {
    /**
     * Construct an instance of AdGroupServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupServiceStub) {
            return this.adGroupServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupService.
        this.adGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupServiceStubMethods = ['getAdGroup', 'mutateAdGroups'];
        for (const methodName of adGroupServiceStubMethods) {
            const callPromise = this.adGroupServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroups(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAdGroups(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupServiceStub.then(stub => {
...
//# sourceMappingURL=ad_group_service_client.js.map