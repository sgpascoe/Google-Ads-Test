...
exports.AssetFieldTypeViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/asset_field_type_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./asset_field_type_view_service_client_config.json");
 ...
 * @memberof v9
 */
class AssetFieldTypeViewServiceClient {
    /**
     * Construct an instance of AssetFieldTypeViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AssetFieldTypeViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.assetFieldTypeViewServiceStub) {
            return this.assetFieldTypeViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AssetFieldTypeViewService.
        this.assetFieldTypeViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AssetFieldTypeViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AssetFieldTypeViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const assetFieldTypeViewServiceStubMethods = ['getAssetFieldTypeView'];
        for (const methodName of assetFieldTypeViewServiceStubMethods) {
            const callPromise = this.assetFieldTypeViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAssetFieldTypeView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAssetFieldTypeView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.assetFieldTypeViewServiceStub.then(stub => {
...
exports.AssetFieldTypeViewServiceClient = AssetFieldTypeViewServiceClient;
//# sourceMappingURL=asset_field_type_view_service_client.js.map