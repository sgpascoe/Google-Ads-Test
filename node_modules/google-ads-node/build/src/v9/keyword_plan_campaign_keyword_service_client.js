 ...
 * `src/v9/keyword_plan_campaign_keyword_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./keyword_plan_campaign_keyword_service_client_config.json");
...
class KeywordPlanCampaignKeywordServiceClient {
    /**
     * Construct an instance of KeywordPlanCampaignKeywordServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.keywordPlanCampaignKeywordServiceStub) {
            return this.keywordPlanCampaignKeywordServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService.
        this.keywordPlanCampaignKeywordServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordPlanCampaignKeywordServiceStubMethods = ['getKeywordPlanCampaignKeyword', 'mutateKeywordPlanCampaignKeywords'];
        for (const methodName of keywordPlanCampaignKeywordServiceStubMethods) {
            const callPromise = this.keywordPlanCampaignKeywordServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getKeywordPlanCampaignKeyword(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateKeywordPlanCampaignKeywords(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.keywordPlanCampaignKeywordServiceStub.then(stub => {
...
//# sourceMappingURL=keyword_plan_campaign_keyword_service_client.js.map