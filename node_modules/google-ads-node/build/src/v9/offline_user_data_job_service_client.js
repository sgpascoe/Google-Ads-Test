 ...
 * `src/v9/offline_user_data_job_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./offline_user_data_job_service_client_config.json");
...
class OfflineUserDataJobServiceClient {
    ...
    constructor(opts) {
        ...
        const runOfflineUserDataJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const runOfflineUserDataJobMetadata = protoFilesRoot.lookup('.google.ads.googleads.v9.resources.OfflineUserDataJobMetadata');
        this.descriptors.longrunning = {
            runOfflineUserDataJob: new this._gaxModule.LongrunningDescriptor(this.operationsClient, runOfflineUserDataJobResponse.decode.bind(runOfflineUserDataJobResponse), runOfflineUserDataJobMetadata.decode.bind(runOfflineUserDataJobMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.OfflineUserDataJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.offlineUserDataJobServiceStub) {
            return this.offlineUserDataJobServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.OfflineUserDataJobService.
        this.offlineUserDataJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.OfflineUserDataJobService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.OfflineUserDataJobService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const offlineUserDataJobServiceStubMethods = ['createOfflineUserDataJob', 'getOfflineUserDataJob', 'addOfflineUserDataJobOperations', 'runOfflineUserDataJob'];
        for (const methodName of offlineUserDataJobServiceStubMethods) {
            const callPromise = this.offlineUserDataJobServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createOfflineUserDataJob(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getOfflineUserDataJob(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    addOfflineUserDataJobOperations(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    runOfflineUserDataJob(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkRunOfflineUserDataJobProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.runOfflineUserDataJob, gax.createDefaultBackoffSettings());
...
//# sourceMappingURL=offline_user_data_job_service_client.js.map