...
exports.TopicViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/topic_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./topic_view_service_client_config.json");
...
class TopicViewServiceClient {
    /**
     * Construct an instance of TopicViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.TopicViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.topicViewServiceStub) {
            return this.topicViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.TopicViewService.
        this.topicViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.TopicViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.TopicViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const topicViewServiceStubMethods = ['getTopicView'];
        for (const methodName of topicViewServiceStubMethods) {
            const callPromise = this.topicViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getTopicView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getTopicView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.topicViewServiceStub.then(stub => {
...
exports.TopicViewServiceClient = TopicViewServiceClient;
//# sourceMappingURL=topic_view_service_client.js.map