 ...
 * `src/v9/asset_group_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./asset_group_service_client_config.json");
...
class AssetGroupServiceClient {
    /**
     * Construct an instance of AssetGroupServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AssetGroupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.assetGroupServiceStub) {
            return this.assetGroupServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AssetGroupService.
        this.assetGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AssetGroupService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AssetGroupService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const assetGroupServiceStubMethods = ['getAssetGroup', 'mutateAssetGroups'];
        for (const methodName of assetGroupServiceStubMethods) {
            const callPromise = this.assetGroupServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAssetGroup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAssetGroup(request, options, callback);
    }
    mutateAssetGroups(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAssetGroups(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.assetGroupServiceStub.then(stub => {
...
//# sourceMappingURL=asset_group_service_client.js.map