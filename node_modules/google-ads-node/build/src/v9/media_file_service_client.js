 ...
 * `src/v9/media_file_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./media_file_service_client_config.json");
...
class MediaFileServiceClient {
    /**
     * Construct an instance of MediaFileServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.MediaFileService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.mediaFileServiceStub) {
            return this.mediaFileServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.MediaFileService.
        this.mediaFileServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.MediaFileService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.MediaFileService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const mediaFileServiceStubMethods = ['getMediaFile', 'mutateMediaFiles'];
        for (const methodName of mediaFileServiceStubMethods) {
            const callPromise = this.mediaFileServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getMediaFile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateMediaFiles(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.mediaFileServiceStub.then(stub => {
...
//# sourceMappingURL=media_file_service_client.js.map