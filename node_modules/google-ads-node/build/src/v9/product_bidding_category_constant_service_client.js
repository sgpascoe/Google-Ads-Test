...
exports.ProductBiddingCategoryConstantServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/product_bidding_category_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./product_bidding_category_constant_service_client_config.json");
...
class ProductBiddingCategoryConstantServiceClient {
    /**
     * Construct an instance of ProductBiddingCategoryConstantServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ProductBiddingCategoryConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.productBiddingCategoryConstantServiceStub) {
            return this.productBiddingCategoryConstantServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ProductBiddingCategoryConstantService.
        this.productBiddingCategoryConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ProductBiddingCategoryConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ProductBiddingCategoryConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const productBiddingCategoryConstantServiceStubMethods = ['getProductBiddingCategoryConstant'];
        for (const methodName of productBiddingCategoryConstantServiceStubMethods) {
            const callPromise = this.productBiddingCategoryConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getProductBiddingCategoryConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getProductBiddingCategoryConstant(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.productBiddingCategoryConstantServiceStub.then(stub => {
...
exports.ProductBiddingCategoryConstantServiceClient = ProductBiddingCategoryConstantServiceClient;
//# sourceMappingURL=product_bidding_category_constant_service_client.js.map