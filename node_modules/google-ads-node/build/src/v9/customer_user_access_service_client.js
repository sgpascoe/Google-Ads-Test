 ...
 * `src/v9/customer_user_access_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_user_access_service_client_config.json");
...
class CustomerUserAccessServiceClient {
    /**
     * Construct an instance of CustomerUserAccessServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerUserAccessService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerUserAccessServiceStub) {
            return this.customerUserAccessServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerUserAccessService.
        this.customerUserAccessServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerUserAccessService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerUserAccessService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerUserAccessServiceStubMethods = ['getCustomerUserAccess', 'mutateCustomerUserAccess'];
        for (const methodName of customerUserAccessServiceStubMethods) {
            const callPromise = this.customerUserAccessServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerUserAccess(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomerUserAccess(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerUserAccessServiceStub.then(stub => {
...
//# sourceMappingURL=customer_user_access_service_client.js.map