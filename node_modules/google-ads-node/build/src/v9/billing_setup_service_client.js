...
exports.BillingSetupServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/billing_setup_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./billing_setup_service_client_config.json");
...
class BillingSetupServiceClient {
    /**
     * Construct an instance of BillingSetupServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.BillingSetupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.billingSetupServiceStub) {
            return this.billingSetupServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.BillingSetupService.
        this.billingSetupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.BillingSetupService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.BillingSetupService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const billingSetupServiceStubMethods = ['getBillingSetup', 'mutateBillingSetup'];
        for (const methodName of billingSetupServiceStubMethods) {
            const callPromise = this.billingSetupServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getBillingSetup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateBillingSetup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.billingSetupServiceStub.then(stub => {
...
exports.BillingSetupServiceClient = BillingSetupServiceClient;
//# sourceMappingURL=billing_setup_service_client.js.map