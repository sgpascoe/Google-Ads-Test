...
exports.CustomerConversionGoalServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/customer_conversion_goal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_conversion_goal_service_client_config.json");
...
class CustomerConversionGoalServiceClient {
    /**
     * Construct an instance of CustomerConversionGoalServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerConversionGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerConversionGoalServiceStub) {
            return this.customerConversionGoalServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerConversionGoalService.
        this.customerConversionGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerConversionGoalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerConversionGoalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerConversionGoalServiceStubMethods = ['mutateCustomerConversionGoals'];
        for (const methodName of customerConversionGoalServiceStubMethods) {
            const callPromise = this.customerConversionGoalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCustomerConversionGoals(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
...
exports.CustomerConversionGoalServiceClient = CustomerConversionGoalServiceClient;
//# sourceMappingURL=customer_conversion_goal_service_client.js.map