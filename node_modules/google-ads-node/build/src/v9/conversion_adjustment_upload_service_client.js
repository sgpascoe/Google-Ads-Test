 ...
 * `src/v9/conversion_adjustment_upload_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./conversion_adjustment_upload_service_client_config.json");
...
class ConversionAdjustmentUploadServiceClient {
    /**
     * Construct an instance of ConversionAdjustmentUploadServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ConversionAdjustmentUploadService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.conversionAdjustmentUploadServiceStub) {
            return this.conversionAdjustmentUploadServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ConversionAdjustmentUploadService.
        this.conversionAdjustmentUploadServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ConversionAdjustmentUploadService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ConversionAdjustmentUploadService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversionAdjustmentUploadServiceStubMethods = ['uploadConversionAdjustments'];
        for (const methodName of conversionAdjustmentUploadServiceStubMethods) {
            const callPromise = this.conversionAdjustmentUploadServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    uploadConversionAdjustments(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.conversionAdjustmentUploadServiceStub.then(stub => {
...
//# sourceMappingURL=conversion_adjustment_upload_service_client.js.map