...
exports.AssetGroupAssetServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/asset_group_asset_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./asset_group_asset_service_client_config.json");
 ...
 * @memberof v9
 */
class AssetGroupAssetServiceClient {
    /**
     * Construct an instance of AssetGroupAssetServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AssetGroupAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.assetGroupAssetServiceStub) {
            return this.assetGroupAssetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AssetGroupAssetService.
        this.assetGroupAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AssetGroupAssetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AssetGroupAssetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const assetGroupAssetServiceStubMethods = ['getAssetGroupAsset', 'mutateAssetGroupAssets'];
        for (const methodName of assetGroupAssetServiceStubMethods) {
            const callPromise = this.assetGroupAssetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAssetGroupAsset(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAssetGroupAssets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAssetGroupAssets(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.assetGroupAssetServiceStub.then(stub => {
...
exports.AssetGroupAssetServiceClient = AssetGroupAssetServiceClient;
//# sourceMappingURL=asset_group_asset_service_client.js.map