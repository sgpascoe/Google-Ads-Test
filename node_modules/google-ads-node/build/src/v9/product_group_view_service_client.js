...
exports.ProductGroupViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/product_group_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./product_group_view_service_client_config.json");
...
class ProductGroupViewServiceClient {
    /**
     * Construct an instance of ProductGroupViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ProductGroupViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.productGroupViewServiceStub) {
            return this.productGroupViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ProductGroupViewService.
        this.productGroupViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ProductGroupViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ProductGroupViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const productGroupViewServiceStubMethods = ['getProductGroupView'];
        for (const methodName of productGroupViewServiceStubMethods) {
            const callPromise = this.productGroupViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getProductGroupView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getProductGroupView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.productGroupViewServiceStub.then(stub => {
...
exports.ProductGroupViewServiceClient = ProductGroupViewServiceClient;
//# sourceMappingURL=product_group_view_service_client.js.map