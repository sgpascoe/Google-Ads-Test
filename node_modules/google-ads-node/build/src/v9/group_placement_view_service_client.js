...
exports.GroupPlacementViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/group_placement_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./group_placement_view_service_client_config.json");
...
class GroupPlacementViewServiceClient {
    /**
     * Construct an instance of GroupPlacementViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.GroupPlacementViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.groupPlacementViewServiceStub) {
            return this.groupPlacementViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.GroupPlacementViewService.
        this.groupPlacementViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.GroupPlacementViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.GroupPlacementViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const groupPlacementViewServiceStubMethods = ['getGroupPlacementView'];
        for (const methodName of groupPlacementViewServiceStubMethods) {
            const callPromise = this.groupPlacementViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getGroupPlacementView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getGroupPlacementView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.groupPlacementViewServiceStub.then(stub => {
...
exports.GroupPlacementViewServiceClient = GroupPlacementViewServiceClient;
//# sourceMappingURL=group_placement_view_service_client.js.map