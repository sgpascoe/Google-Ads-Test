...
exports.CampaignCustomizerServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/campaign_customizer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_customizer_service_client_config.json");
 ...
 * @memberof v9
 */
class CampaignCustomizerServiceClient {
    /**
     * Construct an instance of CampaignCustomizerServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CampaignCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignCustomizerServiceStub) {
            return this.campaignCustomizerServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CampaignCustomizerService.
        this.campaignCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CampaignCustomizerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CampaignCustomizerService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignCustomizerServiceStubMethods = ['mutateCampaignCustomizers'];
        for (const methodName of campaignCustomizerServiceStubMethods) {
            const callPromise = this.campaignCustomizerServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCampaignCustomizers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateCampaignCustomizers(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.campaignCustomizerServiceStub.then(stub => {
...
exports.CampaignCustomizerServiceClient = CampaignCustomizerServiceClient;
//# sourceMappingURL=campaign_customizer_service_client.js.map