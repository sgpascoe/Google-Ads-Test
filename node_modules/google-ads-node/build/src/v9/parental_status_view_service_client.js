...
exports.ParentalStatusViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/parental_status_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./parental_status_view_service_client_config.json");
...
class ParentalStatusViewServiceClient {
    /**
     * Construct an instance of ParentalStatusViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ParentalStatusViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.parentalStatusViewServiceStub) {
            return this.parentalStatusViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ParentalStatusViewService.
        this.parentalStatusViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ParentalStatusViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ParentalStatusViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const parentalStatusViewServiceStubMethods = ['getParentalStatusView'];
        for (const methodName of parentalStatusViewServiceStubMethods) {
            const callPromise = this.parentalStatusViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getParentalStatusView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getParentalStatusView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.parentalStatusViewServiceStub.then(stub => {
...
exports.ParentalStatusViewServiceClient = ParentalStatusViewServiceClient;
//# sourceMappingURL=parental_status_view_service_client.js.map