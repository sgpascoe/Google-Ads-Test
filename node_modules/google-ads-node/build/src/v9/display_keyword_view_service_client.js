...
exports.DisplayKeywordViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/display_keyword_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./display_keyword_view_service_client_config.json");
...
class DisplayKeywordViewServiceClient {
    /**
     * Construct an instance of DisplayKeywordViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.DisplayKeywordViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.displayKeywordViewServiceStub) {
            return this.displayKeywordViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.DisplayKeywordViewService.
        this.displayKeywordViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.DisplayKeywordViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.DisplayKeywordViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const displayKeywordViewServiceStubMethods = ['getDisplayKeywordView'];
        for (const methodName of displayKeywordViewServiceStubMethods) {
            const callPromise = this.displayKeywordViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDisplayKeywordView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getDisplayKeywordView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.displayKeywordViewServiceStub.then(stub => {
...
exports.DisplayKeywordViewServiceClient = DisplayKeywordViewServiceClient;
//# sourceMappingURL=display_keyword_view_service_client.js.map