...
exports.AdGroupBidModifierServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/ad_group_bid_modifier_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_bid_modifier_service_client_config.json");
...
class AdGroupBidModifierServiceClient {
    /**
     * Construct an instance of AdGroupBidModifierServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AdGroupBidModifierService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupBidModifierServiceStub) {
            return this.adGroupBidModifierServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AdGroupBidModifierService.
        this.adGroupBidModifierServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AdGroupBidModifierService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AdGroupBidModifierService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupBidModifierServiceStubMethods = ['getAdGroupBidModifier', 'mutateAdGroupBidModifiers'];
        for (const methodName of adGroupBidModifierServiceStubMethods) {
            const callPromise = this.adGroupBidModifierServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAdGroupBidModifier(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateAdGroupBidModifiers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.adGroupBidModifierServiceStub.then(stub => {
...
exports.AdGroupBidModifierServiceClient = AdGroupBidModifierServiceClient;
//# sourceMappingURL=ad_group_bid_modifier_service_client.js.map