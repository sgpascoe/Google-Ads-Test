 ...
 * `src/v9/geo_target_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./geo_target_constant_service_client_config.json");
...
class GeoTargetConstantServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.GeoTargetConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.geoTargetConstantServiceStub) {
            return this.geoTargetConstantServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.GeoTargetConstantService.
        this.geoTargetConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.GeoTargetConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.GeoTargetConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const geoTargetConstantServiceStubMethods = ['getGeoTargetConstant', 'suggestGeoTargetConstants'];
        for (const methodName of geoTargetConstantServiceStubMethods) {
            const callPromise = this.geoTargetConstantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getGeoTargetConstant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    suggestGeoTargetConstants(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.geoTargetConstantServiceStub.then(stub => {
...
//# sourceMappingURL=geo_target_constant_service_client.js.map