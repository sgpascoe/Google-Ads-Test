 ...
 * `src/v9/keyword_plan_campaign_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./keyword_plan_campaign_service_client_config.json");
...
class KeywordPlanCampaignServiceClient {
    /**
     * Construct an instance of KeywordPlanCampaignServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.KeywordPlanCampaignService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.keywordPlanCampaignServiceStub) {
            return this.keywordPlanCampaignServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.KeywordPlanCampaignService.
        this.keywordPlanCampaignServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.KeywordPlanCampaignService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.KeywordPlanCampaignService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordPlanCampaignServiceStubMethods = ['getKeywordPlanCampaign', 'mutateKeywordPlanCampaigns'];
        for (const methodName of keywordPlanCampaignServiceStubMethods) {
            const callPromise = this.keywordPlanCampaignServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getKeywordPlanCampaign(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateKeywordPlanCampaigns(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.mutateKeywordPlanCampaigns(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.keywordPlanCampaignServiceStub.then(stub => {
...
//# sourceMappingURL=keyword_plan_campaign_service_client.js.map