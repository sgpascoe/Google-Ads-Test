...
exports.CombinedAudienceServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/combined_audience_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./combined_audience_service_client_config.json");
...
class CombinedAudienceServiceClient {
    /**
     * Construct an instance of CombinedAudienceServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CombinedAudienceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.combinedAudienceServiceStub) {
            return this.combinedAudienceServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CombinedAudienceService.
        this.combinedAudienceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CombinedAudienceService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CombinedAudienceService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const combinedAudienceServiceStubMethods = ['getCombinedAudience'];
        for (const methodName of combinedAudienceServiceStubMethods) {
            const callPromise = this.combinedAudienceServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCombinedAudience(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getCombinedAudience(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.combinedAudienceServiceStub.then(stub => {
...
exports.CombinedAudienceServiceClient = CombinedAudienceServiceClient;
//# sourceMappingURL=combined_audience_service_client.js.map