 ...
 * `src/v9/merchant_center_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./merchant_center_link_service_client_config.json");
...
class MerchantCenterLinkServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.MerchantCenterLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.merchantCenterLinkServiceStub) {
            return this.merchantCenterLinkServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.MerchantCenterLinkService.
        this.merchantCenterLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.MerchantCenterLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.MerchantCenterLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const merchantCenterLinkServiceStubMethods = ['listMerchantCenterLinks', 'getMerchantCenterLink', 'mutateMerchantCenterLink'];
        for (const methodName of merchantCenterLinkServiceStubMethods) {
            const callPromise = this.merchantCenterLinkServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listMerchantCenterLinks(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getMerchantCenterLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    mutateMerchantCenterLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.merchantCenterLinkServiceStub.then(stub => {
...
//# sourceMappingURL=merchant_center_link_service_client.js.map