 ...
 * `src/v9/customer_negative_criterion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_negative_criterion_service_client_config.json");
...
class CustomerNegativeCriterionServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.CustomerNegativeCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerNegativeCriterionServiceStub) {
            return this.customerNegativeCriterionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.CustomerNegativeCriterionService.
        this.customerNegativeCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.CustomerNegativeCriterionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.CustomerNegativeCriterionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerNegativeCriterionServiceStubMethods = ['getCustomerNegativeCriterion', 'mutateCustomerNegativeCriteria'];
        for (const methodName of customerNegativeCriterionServiceStubMethods) {
            const callPromise = this.customerNegativeCriterionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCustomerNegativeCriterion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    mutateCustomerNegativeCriteria(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.customerNegativeCriterionServiceStub.then(stub => {
...
//# sourceMappingURL=customer_negative_criterion_service_client.js.map