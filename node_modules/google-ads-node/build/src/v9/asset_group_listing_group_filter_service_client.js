...
exports.AssetGroupListingGroupFilterServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/asset_group_listing_group_filter_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./asset_group_listing_group_filter_service_client_config.json");
...
class AssetGroupListingGroupFilterServiceClient {
    /**
     * Construct an instance of AssetGroupListingGroupFilterServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AssetGroupListingGroupFilterService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.assetGroupListingGroupFilterServiceStub) {
            return this.assetGroupListingGroupFilterServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AssetGroupListingGroupFilterService.
        this.assetGroupListingGroupFilterServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AssetGroupListingGroupFilterService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AssetGroupListingGroupFilterService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const assetGroupListingGroupFilterServiceStubMethods = ['mutateAssetGroupListingGroupFilters'];
        for (const methodName of assetGroupListingGroupFilterServiceStubMethods) {
            const callPromise = this.assetGroupListingGroupFilterServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateAssetGroupListingGroupFilters(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateAssetGroupListingGroupFilters(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.assetGroupListingGroupFilterServiceStub.then(stub => {
...
exports.AssetGroupListingGroupFilterServiceClient = AssetGroupListingGroupFilterServiceClient;
//# sourceMappingURL=asset_group_listing_group_filter_service_client.js.map