...
exports.AgeRangeViewServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/age_range_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./age_range_view_service_client_config.json");
...
class AgeRangeViewServiceClient {
    /**
     * Construct an instance of AgeRangeViewServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.AgeRangeViewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.ageRangeViewServiceStub) {
            return this.ageRangeViewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.AgeRangeViewService.
        this.ageRangeViewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.AgeRangeViewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.AgeRangeViewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const ageRangeViewServiceStubMethods = ['getAgeRangeView'];
        for (const methodName of ageRangeViewServiceStubMethods) {
            const callPromise = this.ageRangeViewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAgeRangeView(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getAgeRangeView(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.ageRangeViewServiceStub.then(stub => {
...
exports.AgeRangeViewServiceClient = AgeRangeViewServiceClient;
//# sourceMappingURL=age_range_view_service_client.js.map