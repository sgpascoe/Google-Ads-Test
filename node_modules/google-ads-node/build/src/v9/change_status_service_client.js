...
exports.ChangeStatusServiceClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v9/change_status_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./change_status_service_client_config.json");
...
class ChangeStatusServiceClient {
    /**
     * Construct an instance of ChangeStatusServiceClient.
     *
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v9.services.ChangeStatusService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.changeStatusServiceStub) {
            return this.changeStatusServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v9.services.ChangeStatusService.
        this.changeStatusServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v9.services.ChangeStatusService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v9.services.ChangeStatusService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const changeStatusServiceStubMethods = ['getChangeStatus'];
        for (const methodName of changeStatusServiceStubMethods) {
            const callPromise = this.changeStatusServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getChangeStatus(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getChangeStatus(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    close() {
        this.initialize();
        if (!this._terminated) {
            return this.changeStatusServiceStub.then(stub => {
...
exports.ChangeStatusServiceClient = ChangeStatusServiceClient;
//# sourceMappingURL=change_status_service_client.js.map